...
import{r as p,j as a,C as B,_ as me,B as pe,S as ue,M as fe,R as he,a as ye}from"./vendor-react-Dhy20vu4.js";import{B as ge,p as _e}from"./vendor-utils-DahDrsZr.js";import{m as ve}from"./vendor-katex-DnHNbJWt.js";import"./vendor-Duqdn4fa.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const h of d.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&r(h)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function r(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}})();function we({chapters:s,currentChapter:e,onChapterSelect:t,currentScript:r,onScriptSelect:o,selectedTopicId:d,onTopicSelect:h,loading:n}){var c;const y=p.useMemo(()=>{var b;const i=(b=e==null?void 0:e.content)==null?void 0:b.intro;if(!i)return[];let l="";if(typeof i=="string")l=i;else if(typeof i=="object"&&i.body)l=i.body;else return[];const u=/^###\s+(.+)$/gm,w=[];let k;for(;(k=u.exec(l))!==null;){const P=k[1].trim(),q="topic-"+P.replace(/\s+/g,"-").toLowerCase();w.push({id:q,title:P})}return w},[e]);return a.jsxs("div",{className:"top-nav-container",children:[a.jsx("div",{className:"nav-group",children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:i=>{const l=s.find(u=>u.id===i.target.value);l&&t(l)},disabled:n||s.length===0,className:"custom-select",children:[a.jsx("option",{value:"",disabled:!0,children:n?"載入中...":"📖 章節選擇"}),s.map(i=>a.jsx("option",{value:i.id,children:i.title},i.id))]}),a.jsx(B,{className:"select-icon",size:16})]})}),a.jsx("div",{className:`nav-group ${!e||y.length===0?"disabled":""}`,children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"topic-select",name:"topic-select",value:d,onChange:i=>h(i.target.value),disabled:!e||y.length===0,className:"custom-select",children:[a.jsx("option",{value:"",children:"💡 重點導覽"}),y.map(i=>a.jsx("option",{value:i.id,children:i.title},i.id))]}),a.jsx(B,{className:"select-icon",size:16})]})}),a.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"script-select",name:"script-select",value:(r==null?void 0:r.filename)||"",onChange:i=>{if(e!=null&&e.examples){const l=e.examples.find(u=>u.filename===i.target.value);l&&o(l)}},disabled:!e||!e.examples,className:"custom-select",children:[a.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(c=e==null?void 0:e.examples)==null?void 0:c.map(i=>a.jsx("option",{value:i.filename,children:i.filename},i.filename))]}),a.jsx(B,{className:"select-icon",size:16})]})})]})}const be=new ge(ve({throwOnError:!1,output:"html",nonStandard:!0})),xe=p.memo(({chapter:s,onCodeClick:e,selectedTopicId:t,output:r,isRunning:o,plotImages:d})=>{const h=p.useMemo(()=>{var y;if(!s)return null;const n=(y=s.content)==null?void 0:y.intro;if(n){let c="";typeof n=="string"?c=n:typeof n=="object"&&(c=`# ${n.title||""}
...
`)),n.body&&(c+=`
## 📝 章節重點詳細解說的內容
${n.body}`)),c=c.replace(/##\s*💻\s*應用場景清單[\s\S]*?(?=##|$)/g,""),c=c.replace(/\s*\$\$\s*/g,`
$$
`).replace(new RegExp("(?<!\\$)\\$(?!\\$)\\s*(.*?)\\s*(?<!\\$)\\$(?!\\$)","g"),"$$$1$");let i=be.parse(c);i=i.replace(/<h3>(.*?)<\/h3>/g,(b,P)=>`<h3 id="${"topic-"+P.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${P}</h3>`);let u=_e.sanitize(i,{ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename"]});return[...s.examples||[]].sort((b,P)=>P.filename.length-b.filename.length).forEach(b=>{const P=b.filename.replace(".","\\."),q=new RegExp(`(?<!['".\\w])(${P})(?!['".\\w])`,"g");u=u.replace(q,`<span class="code-link" data-filename="${b.filename}">${b.filename}</span>`)}),u}else{const c=s.examples||[];let i=`
      ...
      `,i}},[s]);return p.useEffect(()=>{const n=y=>{if(y.target.classList.contains("code-link")){const c=y.target.dataset.filename;let i=null;s!=null&&s.examples&&(i=s.examples.find(l=>l.filename===c),i&&!i.metadata&&(i.metadata={description:i.title})),i&&e(i)}};return document.addEventListener("click",n),()=>document.removeEventListener("click",n)},[s,e]),p.useEffect(()=>{const n=document.querySelector(".content-scroll");n&&(n.scrollTop=0)},[s]),p.useEffect(()=>{if(t){const n=document.getElementById(t);n&&n.scrollIntoView({behavior:"smooth",block:"start"})}},[t]),p.useEffect(()=>{if(r||d&&d.length>0||o){const n=document.querySelector(".content-scroll");n&&n.scrollTo({top:0,behavior:"instant"})}},[r,d,o]),a.jsx("div",{className:"content-panel",children:a.jsx("div",{className:"content-scroll",children:r||d&&d.length>0||o?a.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[o&&a.jsxs("div",{className:"running-indicator",children:[a.jsx("div",{className:"spinner"}),a.jsx("span",{children:"程式執行中..."})]}),r&&a.jsx("pre",{className:"output-text",children:r}),d&&d.length>0&&a.jsx("div",{className:"output-images",children:d.map((n,y)=>a.jsx("div",{className:"output-image",children:a.jsx("img",{src:n,alt:`Plot ${y+1}`})},y))})]}):h?a.jsx("div",{className:"markdown-body",dangerouslySetInnerHTML:{__html:h}}):a.jsx("div",{className:"welcome-screen",children:a.jsxs("div",{className:"welcome-card premium-welcome",children:[a.jsxs("div",{className:"welcome-brand",children:[a.jsx("img",{src:"book-cover.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),a.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%9f%ba%e7%a4%8e%e7%af%87dm2301/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),a.jsxs("div",{className:"welcome-content",children:[a.jsxs("h2",{className:"welcome-title",children:["手術刀般精準的 FRM 用 Python",a.jsx("br",{}),"科學管控財金風險：基礎篇"]}),a.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),a.jsxs("div",{className:"welcome-text-scroll",children:[a.jsx("p",{children:"本書使用了當紅的程式語言 Python，從程式設計的基本觀念談起。沒有 Python 基礎也沒關係，完整的 Python 介紹，讓您能順利銜接資料科學家最常用的套件整理，包括 Numpy，以及特別針對格式化表格類處理的 Pandas，也充分介紹了 Dataframe 的各種應用。"}),a.jsx("p",{children:"在有了充足的資料之後，接著需要有可以展示數據的工具。除了大家最愛用的 Matplotlib 之外，也介紹了高手才會用的 Seaborn。當熟悉了工具之後，就正式進入了金融理論，包括基礎的機率及統計、各種模型及機率分佈，以及抽樣、信賴區間等內容說明。"}),a.jsx("p",{children:"最後則進入到金融領域，除了介紹各種計算的演算法、模型、術語，也結合了前面所學的 Python 及工具，並講解金融商品最重要的「固定收益分析」。"}),a.jsx("p",{children:"本書從科學下手，讓您精準了解金融原理，確保金錢不再陷入水深火熱之中，將是您從科學到金融領域最重要的橋樑。"})]})]})]})})})})});function Pe(){return null}const Se=`
# QuantLib (ql) 強大模擬層
...
try:
    ...
    pass
`;let O=null,D=null;class Le{constructor(e){this.onProgress=e,this.current=0,this.target=0,this.message="",this.interval=null,this.step=.1}start(){this.interval||(this.interval=setInterval(()=>{if(this.current<this.target){const e=this.target-this.current,t=e>20?3.5:e>5?1.5:.5;this.current=Math.min(this.current+t,this.target),this.onProgress(Math.floor(this.current),this.message)}else this.target<99&&(this.current=Math.min(this.current+.08,99.9),this.onProgress(Math.floor(this.current),this.message))},100))}update(e,t){this.target=e,t&&(this.message=t)}async yieldToUI(){return new Promise(e=>setTimeout(e,30))}finish(e="Ready!"){this.interval&&clearInterval(this.interval),this.current=100,this.onProgress(100,e)}}async function Ne(s){return O?(s&&s(100,"Ready"),O):D?D.then(e=>(s&&s(100,"Ready"),e)):(D=(async()=>{const e=new Le(s);e.start();try{e.update(10,"正在啟動 Python 直譯器 (v0.26.4)...");let t=null,r=3;for(;r>0;)try{const l="https://cdn.jsdelivr.net/pyodide/v0.26.4/full/";console.log("Using Pyodide CDN for packages:",l),t=await window.loadPyodide({indexURL:l});break}catch(l){if(console.warn(`Failed to load Pyodide (attempts left: ${r-1}):`,l),r--,r===0)throw l;await new Promise(u=>setTimeout(u,1e3))}e.update(25,"引擎啟動完成，正在檢查本地暫存環境..."),await e.yieldToUI();const o="/lib/python3.12/site-packages";try{t.FS.mkdirTree(o)}catch{}t.FS.mount(t.FS.filesystems.IDBFS,{},o),e.update(26,"正在從本地儲存區載入 Python 環境..."),await new Promise(l=>{t.FS.syncfs(!0,u=>{u&&console.error("IDBFS sync error:",u),l()})}),await e.yieldToUI();const d=["numpy","pandas","matplotlib","scipy","micropip"],h=["numpy-financial","pandas-datareader","pyodide-http","pymoo==0.4.1","seaborn","statsmodels","sympy"],n=t.FS.readdir(o),y=d.filter(l=>!n.includes(l)&&!n.some(u=>u.startsWith(l+"-"))),c=h.filter(l=>{const u=l.replace("-","_");return!n.includes(l)&&!n.includes(u)&&!n.some(w=>w.startsWith(l+"-"))&&!n.some(w=>w.startsWith(u+"-"))});if(y.length>0||c.length>0){const l=[...y,...c];if(e.update(30,`正在同步並安裝套件: ${l.join(", ")}...`),y.length>0&&(e.update(40,`正在從 CDN 獲取核心科學套件 (${y.length} 個)...`),await t.loadPackage(y)),c.length>0){e.update(70,`正在掛載第三方擴充資源 (${c.length} 個)...`),await t.loadPackage("micropip");const u=t.pyimport("micropip"),w=c.map(k=>k==="numpy-financial"?"/pwa_FRM_Book1_python/wheels/numpy_financial-1.0.0-py3-none-any.whl":k);await u.install(w)}e.update(85,"正在固化環境映射至本地磁碟..."),await new Promise(u=>{t.FS.syncfs(!1,w=>{w&&console.error("IDBFS save error:",w),u()})}),e.update(90,"✅ 環境已完成本地持久化儲存")}else e.update(90,"🚀 偵測到本地環境快照，已跳過網路請求");return await e.yieldToUI(),e.update(92,"⚙️ 配置：正在載入環境優化補丁..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(`
import warnings
warnings.simplefilter("ignore", DeprecationWarning)
warnings.simplefilter("ignore", FutureWarning)
warnings.simplefilter("ignore", SyntaxWarning)
...
try:
    ...
    if not hasattr(scipy.stats, 'binom_test') and hasattr(scipy.stats, 'binomtest'):
        ...
        scipy.stats.binom_test = binom_test_shim
                ...
                `)]),await e.yieldToUI(),e.update(98,"🚀 系統：正在啟動 Pymoo & QuantLib 虛擬層..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(Ee),t.runPythonAsync(je),t.runPythonAsync(Se),t.runPythonAsync(ke)]),e.update(99,"🛡️ 系統：權限校正與輸入掛鉤注入..."),await t.runPythonAsync(`
import builtins
import js
def custom_input(prompt = ""):
    try:
...
builtins.input = custom_input
            `),await e.yieldToUI(),O=t,D=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw D=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),D)}async function qe(s,e,t=3e4){let r;const o=new Promise((d,h)=>{r=setTimeout(()=>{h(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([s.runPythonAsync(e),o])}finally{clearTimeout(r)}}async function Me(s){if(s)try{await s.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
...
if plt.style.available and 'default' in plt.style.available:
    ...
    `)}catch(t){console.error("✗ Matplotlib 初始化失敗:",t)}}async function De(s){try{await s.runPythonAsync(`
import matplotlib.pyplot as plt
if len(plt.get_fignums()) > 0:
    plt.show()
    `)}catch(e){console.error("Failed to show plots:",e)}}function K(s){const e=s.message||String(s),t=[{pattern:/NameError: name '(.+)' is not defined/,format:r=>`❌ 變數錯誤：'${r[1]}' 未定義
...
• 確認模組名稱正確
• 檢查是否支援該模組
• 查看完整錯誤訊息了解詳情`}];for(const{pattern:r,format:o}of t){const d=e.match(r);if(d)return o(d)}return`❌ 執行錯誤
...
• 逐行執行程式碼找出問題
• 使用 print() 輸出變數值
• 簡化程式碼，逐步測試`}class Fe{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),r=this.metrics[e].start,o=t-r;return this.metrics[e].end=t,this.metrics[e].duration=o,this.log(e,o),o}log(e,t){const r=t<100?"⚡":t<1e3?"⏱️":"🐌",o=t<100?"color: green":t<1e3?"color: orange":"color: red";console.log(`%c${r} ${e}: ${t.toFixed(2)}ms`,o),t>1e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,r)=>t+r,0),average:e.reduce((t,r)=>t+r,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.log(`總計測量: ${e.count} 次`),console.log(`總時間: ${e.total.toFixed(2)}ms`),console.log(`平均時間: ${e.average.toFixed(2)}ms`),console.log(`最快: ${e.min.toFixed(2)}ms`),console.log(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,r])=>{r.duration!==null&&console.log(`${t}: ${r.duration.toFixed(2)}ms`)}),console.groupEnd()}}const F=new Fe;F.setEnabled(!1);let X=!1;function Ie(){if(!X&&(X=!0,"PerformanceObserver"in window)){new PerformanceObserver(o=>{const d=o.getEntries(),h=d[d.length-1];console.log("🎨 LCP:",h.renderTime||h.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(o=>{o.getEntries().forEach(h=>{console.log("⚡ FID:",h.processingStart-h.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(o=>{o.getEntries().forEach(h=>{h.hadRecentInput||(t+=h.value)}),console.log("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const Ce=p.lazy(()=>me(()=>import("./CodePreviewPanel-BAmgNmSY.js"),__vite__mapDeps([0,1,2,3]))),ee={pandas:"pandas",matplotlib:"matplotlib",scipy:"scipy",statsmodels:"statsmodels",sympy:"sympy",autograd:"autograd",lxml:"lxml",openpyxl:"openpyxl",requests:"requests",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",mpl_toolkits:"matplotlib",pylab:"matplotlib"},te={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"};function Te(){const[s,e]=p.useState(null),[t,r]=p.useState(!0),[o,d]=p.useState(0),[h,n]=p.useState("初始化中..."),[y,c]=p.useState([]),[i,l]=p.useState(!0),[u,w]=p.useState(null),[k,b]=p.useState(null),[P,q]=p.useState(""),[C,x]=p.useState(""),[W,M]=p.useState([]),[T,R]=p.useState(!1),[U,ae]=p.useState(!1),[E,se]=p.useState(()=>{const f=localStorage.getItem("theme");return f==="dark"||!f&&!1}),[z,ne]=p.useState(600),[A]=p.useState(new Set),[H,G]=p.useState(null);p.useEffect(()=>{l(!0);const f=`/pwa_FRM_Book1_python/data/chapters.json?t=${Date.now()}`;fetch(f).then(m=>m.json()).then(m=>{m&&m.length>0&&c(m),l(!1)}).catch(m=>{console.error("Failed to load chapters:",m),l(!1)})},[]),p.useEffect(()=>{Ne((m,_)=>{d(m),n(_)}).then(m=>{e(m),r(!1),F.end("pyodide-init")}),Ie();const f=[];if("serviceWorker"in navigator){const m=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(S=>{S.forEach(j=>j.update())})},36e5),_=()=>{};navigator.serviceWorker.addEventListener("controllerchange",_),f.push(()=>{clearInterval(m),navigator.serviceWorker.removeEventListener("controllerchange",_)})}if("storage"in navigator&&"estimate"in navigator.storage){const m=async()=>{try{const S=await navigator.storage.estimate();S.usage&&S.quota&&S.usage/S.quota*100>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}catch(S){console.warn("Failed to check storage quota:",S)}};m();const _=setInterval(m,300*1e3);f.push(()=>clearInterval(_))}return()=>{f.forEach(m=>m())}},[]),p.useEffect(()=>{localStorage.setItem("theme",E?"dark":"light"),document.documentElement.setAttribute("data-theme",E?"dark":"light")},[E]);const V=async(f,m=!1)=>{var Z;if(!s)return;const _=f.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!_)return;const S=["sys","os","io","time","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib"],j=["numpy","pandas","matplotlib","scipy","micropip","js","builtins","QuantLib"],L=[...new Set(_.map(v=>{const g=v.trim().split(/\s+/);return g[0]==="from",g[1].split(".")[0]}))].filter(v=>!S.includes(v)&&!j.includes(v)).filter(v=>!A.has(v));if(L.length===0)return;const $=[],Y=new URL("/pwa_FRM_Book1_python/",window.location.origin).href;if(L.forEach(v=>{const g=ee[v];g?($.push(g.endsWith(".whl")?Y+g:g),(te[v]||[]).forEach(I=>{const Q=te[I]||I;$.push(Q.endsWith(".whl")?Y+Q:Q)})):$.push(v)}),$.length>0)try{const v=[...new Set($)];m||x(g=>g+`正在動態載入所需套件 [${L.join(", ")}]...
`),await s.loadPackage("micropip"),await s.runPythonAsync(`
import micropip
await micropip.install(${JSON.stringify(v)}, keep_going=True)
        `),L.includes("matplotlib")&&(await J(s),H||G("AGG")),L.forEach(g=>{A.add(g);const N=ee[g];N&&!N.endsWith(".whl")&&A.add(N)}),m||x(g=>g+`✅ 套件載入完成。
`)}catch(v){if(console.warn("Dependency loading failed:",v),!m){const g=v.message||String(v);if(g.includes("Can't find a pure Python 3 wheel")){const N=((Z=g.match(/for: '([^']+)'/))==null?void 0:Z[1])||"unknown";x(I=>I+`⚠️ 套件 "${N}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else x(N=>N+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},re=async f=>{if(!(!s||T||!f)){F.start("run-code"),R(!0),x(`執行中...
`),M([]);try{await Me(s);const m=f.includes("matplotlib.widgets")||f.includes("Slider")||f.includes("Button");ae(m);const _=m?"module://matplotlib_pyodide.wasm_backend":"AGG";if(H!==_&&(await J(s,m),G(_)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),m){const j=document.getElementById("pyodide-plot-container");j&&(j.innerHTML="",window.document.pyodideMplTarget=j)}await V(f);try{await qe(s,f)}catch(j){const L=await s.runPythonAsync("sys.stdout.getvalue()"),$=K(j);x((L?L+`
`:"")+$),R(!1),F.end("run-code");return}const S=await s.runPythonAsync("sys.stdout.getvalue()");if(x(S||"執行完成（無文字內容輸出 ）"),U)await De(s);else{const j=await $e(s);M(j)}}catch(m){const _=K(m);x(_),console.error(m)}finally{R(!1),F.end("run-code")}}},oe=f=>{if(w(f),b(null),q(""),x(""),M([]),f&&f.examples&&s){const m=f.examples.map(_=>_.code).join(`
`);V(m,!0)}},ie=f=>{b(f),x(""),M([])},le=f=>{b(f),x(""),M([])},de=()=>{b(null),x(""),M([])},ce=t;return a.jsxs("div",{className:`app ${E?"dark":""}`,children:[a.jsxs("div",{className:"main-content",children:[a.jsxs("div",{className:"top-bar",children:[a.jsxs("div",{className:"top-bar-left",children:[a.jsx(pe,{size:20,className:"logo-icon"}),a.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),a.jsx(we,{chapters:y,currentChapter:u,onChapterSelect:oe,currentScript:k,onScriptSelect:le,selectedTopicId:P,onTopicSelect:q,loading:i}),a.jsx("div",{className:"top-bar-right",children:a.jsx("button",{className:"theme-toggle",onClick:()=>se(!E),title:E?"切換到亮色模式":"切換到暗色模式",children:E?a.jsx(ue,{size:20}):a.jsx(fe,{size:20})})})]}),ce&&a.jsx("div",{className:"hydration-overlay",children:a.jsxs("div",{className:"hydration-card",children:[a.jsxs("div",{className:"hydration-header",children:[a.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),a.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),a.jsx("div",{className:"hydration-progress-container",children:a.jsx("div",{className:"hydration-progress-bar",style:{width:`${o}%`}})}),a.jsxs("div",{className:"hydration-status",children:[a.jsx("span",{children:h}),a.jsxs("span",{children:[o,"%"]})]})]})}),a.jsxs("div",{className:"panes-container",children:[a.jsx("div",{className:"content-pane",children:a.jsx(xe,{chapter:u,onCodeClick:ie,selectedTopicId:P,darkMode:E,output:C,isRunning:T,plotImages:W,onClearOutput:()=>{x(""),M([])}})}),k&&a.jsx("div",{className:"preview-pane",style:{width:`${z}px`},children:a.jsx(p.Suspense,{fallback:a.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:a.jsx(Ce,{script:k,onClose:de,onRun:re,isRunning:T,isLoading:t,output:C,images:W,isInteractive:U,darkMode:E,width:z,onResize:ne})})})]})]}),a.jsx(Pe,{pyodide:s})]})}he.createRoot(document.getElementById("root")).render(a.jsx(ye.StrictMode,{children:a.jsx(Te,{})}));
