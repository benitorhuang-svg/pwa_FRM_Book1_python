...
import{r as p,j as a,C as B,_ as me,B as pe,S as ue,M as fe,R as ge,a as he}from"./vendor-react-Dhy20vu4.js";import{B as ye,p as _e}from"./vendor-utils-DahDrsZr.js";import{m as ve}from"./vendor-katex-DnHNbJWt.js";import"./vendor-Duqdn4fa.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const g of d.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&n(g)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function n(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}})();function be({chapters:s,currentChapter:e,onChapterSelect:t,currentScript:n,onScriptSelect:o,selectedTopicId:d,onTopicSelect:g,loading:r}){var c;const h=p.useMemo(()=>{var w;const i=(w=e==null?void 0:e.content)==null?void 0:w.intro;if(!i)return[];let l="";if(typeof i=="string")l=i;else if(typeof i=="object"&&i.body)l=i.body;else return[];const u=/^###\s+(.+)$/gm,b=[];let S;for(;(S=u.exec(l))!==null;){const k=S[1].trim(),A="topic-"+k.replace(/\s+/g,"-").toLowerCase();b.push({id:A,title:k})}return b},[e]);return a.jsxs("div",{className:"top-nav-container",children:[a.jsx("div",{className:"nav-group",children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:i=>{const l=s.find(u=>u.id===i.target.value);l&&t(l)},disabled:r||s.length===0,className:"custom-select",children:[a.jsx("option",{value:"",disabled:!0,children:r?"載入中...":"📖 章節選擇"}),s.map(i=>a.jsx("option",{value:i.id,children:i.title},i.id))]}),a.jsx(B,{className:"select-icon",size:16})]})}),a.jsx("div",{className:`nav-group ${!e||h.length===0?"disabled":""}`,children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"topic-select",name:"topic-select",value:d,onChange:i=>g(i.target.value),disabled:!e||h.length===0,className:"custom-select",children:[a.jsx("option",{value:"",children:"💡 重點導覽"}),h.map(i=>a.jsx("option",{value:i.id,children:i.title},i.id))]}),a.jsx(B,{className:"select-icon",size:16})]})}),a.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"script-select",name:"script-select",value:(n==null?void 0:n.filename)||"",onChange:i=>{if(e!=null&&e.examples){const l=e.examples.find(u=>u.filename===i.target.value);l&&o(l)}},disabled:!e||!e.examples,className:"custom-select",children:[a.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(c=e==null?void 0:e.examples)==null?void 0:c.map(i=>a.jsx("option",{value:i.filename,children:i.filename},i.filename))]}),a.jsx(B,{className:"select-icon",size:16})]})})]})}const we=new ye(ve({throwOnError:!1,output:"html",nonStandard:!0})),xe=p.memo(({chapter:s,onCodeClick:e,selectedTopicId:t,output:n,isRunning:o,plotImages:d})=>{const g=p.useMemo(()=>{var h;if(!s)return null;const r=(h=s.content)==null?void 0:h.intro;if(r){let c="";typeof r=="string"?c=r:typeof r=="object"&&(c=`# ${r.title||""}
...
$$
`).replace(new RegExp("(?<!\\$)\\$(?!\\$)\\s*(.*?)\\s*(?<!\\$)\\$(?!\\$)","g"),"$$$1$");let i=we.parse(c);i=i.replace(/<h3>(.*?)<\/h3>/g,(w,k)=>`<h3 id="${"topic-"+k.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${k}</h3>`);let u=_e.sanitize(i,{ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename"]});return[...s.examples||[]].sort((w,k)=>k.filename.length-w.filename.length).forEach(w=>{const k=w.filename.replace(".","\\."),A=new RegExp(`(?<!['".\\w])(${k})(?!['".\\w])`,"g");u=u.replace(A,`<span class="code-link" data-filename="${w.filename}">${w.filename}</span>`)}),u}else{const c=s.examples||[];let i=`
...
builtins.input = custom_input
            `),await e.yieldToUI(),Q=t,M=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw M=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),M)}async function Te(s,e,t=3e4){let n;const o=new Promise((d,g)=>{n=setTimeout(()=>{g(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([s.runPythonAsync(e),o])}finally{clearTimeout(n)}}async function Ie(s){if(s)try{await s.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
