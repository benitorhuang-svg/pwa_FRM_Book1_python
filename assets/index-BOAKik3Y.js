const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CodePreviewPanel-B4Cwvcqu.js","assets/vendor-react-Dhy20vu4.js","assets/vendor-Duqdn4fa.js","assets/CodePreviewPanel-Cz5hs9pL.css"])))=>i.map(i=>d[i]);
import{j as s,C as U,r as d,_ as le,B as de,S as ce,M as me,R as pe,a as ue}from"./vendor-react-Dhy20vu4.js";import{B as fe,p as ge}from"./vendor-utils-DahDrsZr.js";import{m as he}from"./vendor-katex-DnHNbJWt.js";import"./vendor-Duqdn4fa.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function a(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(r){if(r.ep)return;r.ep=!0;const o=a(r);fetch(r.href,o)}})();function ye({chapters:t,currentChapter:e,onChapterSelect:a,currentScript:n,onScriptSelect:r,loading:o}){var c;return s.jsxs("div",{className:"top-nav-container",children:[s.jsxs("div",{className:"nav-group",children:[s.jsx("label",{className:"nav-label",htmlFor:"chapter-select",children:"章節 Selection"}),s.jsxs("div",{className:"custom-select-wrapper",children:[s.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:p=>{const m=t.find(u=>u.id===p.target.value);m&&a(m)},disabled:o||t.length===0,className:"custom-select",children:[s.jsx("option",{value:"",disabled:!0,children:o?"載入中...":"請選擇章節..."}),t.map(p=>s.jsx("option",{value:p.id,children:p.title},p.id))]}),s.jsx(U,{className:"select-icon",size:16})]})]}),s.jsxs("div",{className:`nav-group ${e?"":"disabled"}`,children:[s.jsx("label",{className:"nav-label",htmlFor:"script-select",children:"代碼 Code"}),s.jsxs("div",{className:"custom-select-wrapper",children:[s.jsxs("select",{id:"script-select",name:"script-select",value:(n==null?void 0:n.filename)||"",onChange:p=>{if(e!=null&&e.examples){const m=e.examples.find(u=>u.filename===p.target.value);m&&r(m)}},disabled:!e||!e.examples,className:"custom-select",children:[s.jsx("option",{value:"",disabled:!0,children:"選擇程式碼..."}),(c=e==null?void 0:e.examples)==null?void 0:c.map(p=>s.jsx("option",{value:p.filename,children:p.filename},p.filename))]}),s.jsx(U,{className:"select-icon",size:16})]})]})]})}const _e=new fe(he({throwOnError:!1,output:"html",nonStandard:!0})),ve=d.memo(({chapter:t,onCodeClick:e,darkMode:a,output:n,isRunning:r,plotImages:o,onClearOutput:c})=>{const p=d.useMemo(()=>{var m;if(!t)return null;if((m=t.content)!=null&&m.intro){let u=t.content.intro.replace(/##\s*💻\s*應用場景清單[\s\S]*?(?=##|$)/g,"");u=u.replace(/\s*\$\$\s*/g,`
$$
`).replace(new RegExp("(?<!\\$)\\$(?!\\$)\\s*(.*?)\\s*(?<!\\$)\\$(?!\\$)","g"),"$$$1$");const k=_e.parse(u);let w=ge.sanitize(k,{ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename"]});return[...t.examples||[]].sort((x,j)=>j.filename.length-x.filename.length).forEach(x=>{const j=x.filename.replace(".","\\."),_=new RegExp(`(?<!['"\\w\\.])(${j})(?!['"\\w\\.])`,"g");w=w.replace(_,`<span class="code-link" data-filename="${x.filename}">${x.filename}</span>`)}),w}else{const u=t.examples||[];let k=`
        <div class="chapter-intro">
          <h2>${t.title}</h2>
          <p>本章包含 ${u.length} 個程式範例</p>
          <div class="example-grid">
      `;return u.forEach((g,w)=>{k+=`
...
`:"")+q),F(!1),C.end("run-code");return}const b=await t.runPythonAsync("sys.stdout.getvalue()");if(_(b||"執行完成（無文字內容輸出 ）"),T)await Le(t);else{const v=await Pe(t);E(v)}}catch(i){const h=Z(i);_(h),console.error(i)}finally{F(!1),C.end("run-code")}}},ne=l=>{if(A(l),x(null),_(""),E([]),l&&l.examples&&t){const i=l.examples.map(h=>h.code).join(`
`);H(i,!0)}},re=l=>{x(l),_(""),E([])},oe=l=>{x(l),_(""),E([])},ie=()=>{x(null),_(""),E([])};return a?s.jsx("div",{className:"loading-screen",children:s.jsxs("div",{className:"loading-content",children:[s.jsx("div",{className:"loading-spinner"}),s.jsx("h2",{children:"正在載入 Python 執行環境..."}),s.jsx("div",{className:"progress-container",children:s.jsx("div",{className:"progress-bar",style:{width:`${r}%`}})}),s.jsxs("p",{className:"loading-text",children:[c," (",r,"%)"]}),s.jsx("p",{className:"loading-hint",children:"首次載入需要下載約 10MB 的資源，請稍候"})]})}):s.jsxs("div",{className:`app ${P?"dark":""}`,children:[s.jsxs("div",{className:"main-content",children:[s.jsxs("div",{className:"top-bar",children:[s.jsxs("div",{className:"top-bar-left",children:[s.jsx(de,{size:20,className:"logo-icon"}),s.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),s.jsx(ye,{chapters:m,currentChapter:w,onChapterSelect:ne,currentScript:D,onScriptSelect:oe,loading:k}),s.jsx("div",{className:"top-bar-right",children:s.jsx("button",{className:"theme-toggle",onClick:()=>te(!P),title:P?"切換到亮色模式":"切換到暗色模式",children:P?s.jsx(ce,{size:20}):s.jsx(me,{size:20})})})]}),s.jsxs("div",{className:"panes-container",children:[s.jsx("div",{className:"content-pane",children:s.jsx(ve,{chapter:w,onCodeClick:re,darkMode:P,output:j,isRunning:$,plotImages:B,onClearOutput:()=>{_(""),E([])}})}),D&&s.jsx("div",{className:"preview-pane",style:{width:`${O}px`},children:s.jsx(d.Suspense,{fallback:s.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:s.jsx(qe,{script:D,onClose:ie,onRun:se,isRunning:$,output:j,images:B,isInteractive:T,darkMode:P,width:O,onResize:ae})})})]})]}),s.jsx(be,{pyodide:t})]})}pe.createRoot(document.getElementById("root")).render(s.jsx(ue.StrictMode,{children:s.jsx(je,{})}));
