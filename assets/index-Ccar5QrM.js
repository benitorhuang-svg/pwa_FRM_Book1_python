...
import{r as _,j as r,C as X,_ as ue,B as Ee,S as Ne,M as je,R as Le,a as Fe}from"./vendor-react-CQh-Sngh.js";import{B as Ae,p as Re}from"./vendor-utils-DahDrsZr.js";import{r as Ce}from"./vendor-katex-CppR7rPA.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(l){if(l.ep)return;l.ep=!0;const c=t(l);fetch(l.href,c)}})();function Te({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:n,currentScript:l,onScriptSelect:c,selectedTopicId:o,onTopicSelect:y,loading:b}){var P,d;const i=_.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let f="";const m=a.intro;typeof m=="string"?f=m:m&&typeof m=="object"&&m.body&&(f+=typeof m.body=="string"?m.body:Object.values(m.body).join(`
...
sys.stdout = StringIO()
      `),p){const w=document.getElementById("pyodide-plot-container");w&&(w.innerHTML="",window.document.pyodideMplTarget=w)}try{await Ze(s,u)}catch(w){const N=await s.runPythonAsync("sys.stdout.getvalue()"),B=ce(w);g((N?N+`
