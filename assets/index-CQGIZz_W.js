const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CodePreviewPanel-BZYhx_gu.js","assets/vendor-react-CQh-Sngh.js","assets/vendor-B3CQIlJd.js","assets/CodePreviewPanel-V3Zu5mOS.css"])))=>i.map(i=>d[i]);
import{r as u,j as r,C as V,_ as ce,B as ze,S as Pe,M as Se,R as Ee,a as Ne}from"./vendor-react-CQh-Sngh.js";import{B as je,p as Le}from"./vendor-utils-DahDrsZr.js";import{r as Fe}from"./vendor-katex-CppR7rPA.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(l){if(l.ep)return;l.ep=!0;const c=t(l);fetch(l.href,c)}})();function Ae({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:n,currentScript:l,onScriptSelect:c,selectedTopicId:o,onTopicSelect:y,loading:b}){var k,d;const i=u.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let f="";const m=a.intro;typeof m=="string"?f=m:m&&typeof m=="object"&&m.body&&(f+=typeof m.body=="string"?m.body:Object.values(m.body).join(`
