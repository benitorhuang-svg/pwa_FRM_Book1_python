...
import{r as p,j as a,C as B,_ as me,B as pe,S as ue,M as fe,R as ge,a as ye}from"./vendor-react-Dhy20vu4.js";import{B as he,p as _e}from"./vendor-utils-DahDrsZr.js";import{m as ve}from"./vendor-katex-DnHNbJWt.js";import"./vendor-Duqdn4fa.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const g of d.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&n(g)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function n(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}})();function be({chapters:s,currentChapter:e,onChapterSelect:t,currentScript:n,onScriptSelect:o,selectedTopicId:d,onTopicSelect:g,loading:r}){var c;const y=p.useMemo(()=>{var w;const i=(w=e==null?void 0:e.content)==null?void 0:w.intro;if(!i)return[];let l="";if(typeof i=="string")l=i;else if(typeof i=="object"&&i.body)l=i.body;else return[];const u=/^###\s+(.+)$/gm,b=[];let S;for(;(S=u.exec(l))!==null;){const k=S[1].trim(),A="topic-"+k.replace(/\s+/g,"-").toLowerCase();b.push({id:A,title:k})}return b},[e]);return a.jsxs("div",{className:"top-nav-container",children:[a.jsx("div",{className:"nav-group",children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:i=>{const l=s.find(u=>u.id===i.target.value);l&&t(l)},disabled:r||s.length===0,className:"custom-select",children:[a.jsx("option",{value:"",disabled:!0,children:r?"載入中...":"📖 章節選擇"}),s.map(i=>a.jsx("option",{value:i.id,children:i.title},i.id))]}),a.jsx(B,{className:"select-icon",size:16})]})}),a.jsx("div",{className:`nav-group ${!e||y.length===0?"disabled":""}`,children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"topic-select",name:"topic-select",value:d,onChange:i=>g(i.target.value),disabled:!e||y.length===0,className:"custom-select",children:[a.jsx("option",{value:"",children:"💡 重點導覽"}),y.map(i=>a.jsx("option",{value:i.id,children:i.title},i.id))]}),a.jsx(B,{className:"select-icon",size:16})]})}),a.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:a.jsxs("div",{className:"custom-select-wrapper",children:[a.jsxs("select",{id:"script-select",name:"script-select",value:(n==null?void 0:n.filename)||"",onChange:i=>{if(e!=null&&e.examples){const l=e.examples.find(u=>u.filename===i.target.value);l&&o(l)}},disabled:!e||!e.examples,className:"custom-select",children:[a.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(c=e==null?void 0:e.examples)==null?void 0:c.map(i=>a.jsx("option",{value:i.filename,children:i.filename},i.filename))]}),a.jsx(B,{className:"select-icon",size:16})]})})]})}const we=new he(ve({throwOnError:!1,output:"html",nonStandard:!0})),xe=p.memo(({chapter:s,onCodeClick:e,selectedTopicId:t,output:n,isRunning:o,plotImages:d})=>{const g=p.useMemo(()=>{var y;if(!s)return null;const r=(y=s.content)==null?void 0:y.intro;if(r){let c="";typeof r=="string"?c=r:typeof r=="object"&&(c=`# ${r.title||""}
...
`)}catch(v){if(console.warn("Dependency loading failed:",v),!m){const h=v.message||String(v);if(h.includes("Can't find a pure Python 3 wheel")){const L=((Z=h.match(/for: '([^']+)'/))==null?void 0:Z[1])||"unknown";x(T=>T+`⚠️ 套件 "${L}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
