...
import{r as m,j as s,C as z,_ as pe,B as me,S as ue,M as fe,R as ye,a as he}from"./vendor-react-Dhy20vu4.js";import{B as ge,p as _e}from"./vendor-utils-DahDrsZr.js";import{m as ve}from"./vendor-katex-DnHNbJWt.js";import"./vendor-Duqdn4fa.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const y of d.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&n(y)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function n(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}})();function we({chapters:a,currentChapter:e,onChapterSelect:t,currentScript:n,onScriptSelect:o,selectedTopicId:d,onTopicSelect:y,loading:r}){var c;const h=m.useMemo(()=>{var b;const i=(b=e==null?void 0:e.content)==null?void 0:b.intro;if(!i)return[];let l="";if(typeof i=="string")l=i;else if(typeof i=="object"&&i.body)l=i.body;else return[];const u=/^###\s+(.+)$/gm,w=[];let E;for(;(E=u.exec(l))!==null;){const P=E[1].trim(),q="topic-"+P.replace(/\s+/g,"-").toLowerCase();w.push({id:q,title:P})}return w},[e]);return s.jsxs("div",{className:"top-nav-container",children:[s.jsx("div",{className:"nav-group",children:s.jsxs("div",{className:"custom-select-wrapper",children:[s.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:i=>{const l=a.find(u=>u.id===i.target.value);l&&t(l)},disabled:r||a.length===0,className:"custom-select",children:[s.jsx("option",{value:"",disabled:!0,children:r?"載入中...":"📖 章節選擇"}),a.map(i=>s.jsx("option",{value:i.id,children:i.title},i.id))]}),s.jsx(z,{className:"select-icon",size:16})]})}),s.jsx("div",{className:`nav-group ${!e||h.length===0?"disabled":""}`,children:s.jsxs("div",{className:"custom-select-wrapper",children:[s.jsxs("select",{id:"topic-select",name:"topic-select",value:d,onChange:i=>y(i.target.value),disabled:!e||h.length===0,className:"custom-select",children:[s.jsx("option",{value:"",children:"💡 重點導覽"}),h.map(i=>s.jsx("option",{value:i.id,children:i.title},i.id))]}),s.jsx(z,{className:"select-icon",size:16})]})}),s.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:s.jsxs("div",{className:"custom-select-wrapper",children:[s.jsxs("select",{id:"script-select",name:"script-select",value:(n==null?void 0:n.filename)||"",onChange:i=>{if(e!=null&&e.examples){const l=e.examples.find(u=>u.filename===i.target.value);l&&o(l)}},disabled:!e||!e.examples,className:"custom-select",children:[s.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(c=e==null?void 0:e.examples)==null?void 0:c.map(i=>s.jsx("option",{value:i.filename,children:i.filename},i.filename))]}),s.jsx(z,{className:"select-icon",size:16})]})})]})}const be=new ge(ve({throwOnError:!1,output:"html",nonStandard:!0})),xe=m.memo(({chapter:a,onCodeClick:e,selectedTopicId:t,output:n,isRunning:o,plotImages:d})=>{const y=m.useMemo(()=>{var h;if(!a)return null;const r=(h=a.content)==null?void 0:h.intro;if(r){let c="";typeof r=="string"?c=r:typeof r=="object"&&(c=`# ${r.title||""}
...
`).replace(new RegExp("(?<!\\$)\\$(?!\\$)\\s*(.*?)\\s*(?<!\\$)\\$(?!\\$)","g"),"$$$1$");let i=be.parse(c);i=i.replace(/<h3>(.*?)<\/h3>/g,(b,P)=>`<h3 id="${"topic-"+P.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${P}</h3>`);let u=_e.sanitize(i,{ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename"]});return[...a.examples||[]].sort((b,P)=>P.filename.length-b.filename.length).forEach(b=>{const P=b.filename.replace(".","\\."),q=new RegExp(`(?<!['".\\w])(${P})(?!['".\\w])`,"g");u=u.replace(q,`<span class="code-link" data-filename="${b.filename}">${b.filename}</span>`)}),u}else{const c=a.examples||[];let i=`
      ...
      `,i}},[a]);return m.useEffect(()=>{const r=h=>{if(h.target.classList.contains("code-link")){const c=h.target.dataset.filename;let i=null;a!=null&&a.examples&&(i=a.examples.find(l=>l.filename===c),i&&!i.metadata&&(i.metadata={description:i.title})),i&&e(i)}};return document.addEventListener("click",r),()=>document.removeEventListener("click",r)},[a,e]),m.useEffect(()=>{const r=document.querySelector(".content-scroll");r&&(r.scrollTop=0)},[a]),m.useEffect(()=>{if(t){const r=document.getElementById(t);r&&r.scrollIntoView({behavior:"smooth",block:"start"})}},[t]),m.useEffect(()=>{if(n||d&&d.length>0||o){const r=document.querySelector(".content-scroll");r&&r.scrollTo({top:0,behavior:"instant"})}},[n,d,o]),s.jsx("div",{className:"content-panel",children:s.jsx("div",{className:"content-scroll",children:n||d&&d.length>0||o?s.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[o&&s.jsxs("div",{className:"running-indicator",children:[s.jsx("div",{className:"spinner"}),s.jsx("span",{children:"程式執行中..."})]}),n&&s.jsx("pre",{className:"output-text",children:n}),d&&d.length>0&&s.jsx("div",{className:"output-images",children:d.map((r,h)=>s.jsx("div",{className:"output-image",children:s.jsx("img",{src:r,alt:`Plot ${h+1}`})},h))})]}):y?s.jsx("div",{className:"markdown-body",dangerouslySetInnerHTML:{__html:y}}):s.jsx("div",{className:"welcome-screen",children:s.jsxs("div",{className:"welcome-card premium-welcome",children:[s.jsxs("div",{className:"welcome-brand",children:[s.jsx("img",{src:"book-cover.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),s.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%9f%ba%e7%a4%8e%e7%af%87dm2301/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),s.jsxs("div",{className:"welcome-content",children:[s.jsxs("h2",{className:"welcome-title",children:["手術刀般精準的 FRM 用 Python",s.jsx("br",{}),"科學管控財金風險：基礎篇"]}),s.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),s.jsxs("div",{className:"welcome-text-scroll",children:[s.jsx("p",{children:"本書使用了當紅的程式語言 Python，從程式設計的基本觀念談起。沒有 Python 基礎也沒關係，完整的 Python 介紹，讓您能順利銜接資料科學家最常用的套件整理，包括 Numpy，以及特別針對格式化表格類處理的 Pandas，也充分介紹了 Dataframe 的各種應用。"}),s.jsx("p",{children:"在有了充足的資料之後，接著需要有可以展示數據的工具。除了大家最愛用的 Matplotlib 之外，也介紹了高手才會用的 Seaborn。當熟悉了工具之後，就正式進入了金融理論，包括基礎的機率及統計、各種模型及機率分佈，以及抽樣、信賴區間等內容說明。"}),s.jsx("p",{children:"最後則進入到金融領域，除了介紹各種計算的演算法、模型、術語，也結合了前面所學的 Python 及工具，並講解金融商品最重要的「固定收益分析」。"}),s.jsx("p",{children:"本書從科學下手，讓您精準了解金融原理，確保金錢不再陷入水深火熱之中，將是您從科學到金融領域最重要的橋樑。"})]})]})]})})})})});function Pe(){return null}const ke=`
# QuantLib (ql) 強大模擬層
...
try:
    ...
    def bernoulli(p=0.5):
        class B:
            ...
            def rvs(self, size=None, **kwargs):
                ...
                return np.random.binomial(1, p, size=s)
            def pmf(self, k):
                return p if (k==1).all() if hasattr(k,'all') else (p if k==1 else 1-p)
    ...
    def uniform(loc=0, scale=1):
        class U:
            name = 'uniform'
            def rvs(self, size=None, **kwargs):
                s = 1 if size is None else size
                return np.random.uniform(loc, loc+scale, size=s)
            def pdf(self, x):
                x = np.array(x)
                return np.where((x>=loc)&(x<=loc+scale), 1.0/scale, 0.0)
            def cdf(self, x):
                x = np.array(x)
                return np.clip((x - loc) / scale, 0, 1)
        return U()
    ...
    print('✅ SciPy stub installed (minimal).')
...
try:
    ...
    pass
`;let B=null,D=null;const qe=["https://cdn.jsdelivr.net/pyodide/v0.26.4/full/pyodide.js","https://unpkg.com/pyodide@0.26.4/pyodide.js"];function $e(a){return new Promise((e,t)=>{const n=document.createElement("script");n.src=a,n.crossOrigin="anonymous",n.onload=e,n.onerror=()=>t(new Error(`Failed to load script: ${a}`)),document.head.appendChild(n)})}async function Me(){if(typeof window.loadPyodide!="function"){console.warn("window.loadPyodide not found, loading dynamically...");for(const a of qe)try{if(await $e(a),typeof window.loadPyodide=="function"){console.log(`Pyodide loaded from ${a}`);return}}catch(e){console.warn(`Failed to load Pyodide from ${a}:`,e.message)}throw new Error("Failed to load Pyodide from all CDN sources")}}class De{constructor(e){this.onProgress=e,this.current=0,this.target=0,this.message="",this.interval=null,this.step=.1}start(){this.interval||(this.interval=setInterval(()=>{if(this.current<this.target){const e=this.target-this.current,t=e>20?3.5:e>5?1.5:.5;this.current=Math.min(this.current+t,this.target),this.onProgress(Math.floor(this.current),this.message)}else this.target<99&&(this.current=Math.min(this.current+.08,99.9),this.onProgress(Math.floor(this.current),this.message))},100))}update(e,t){this.target=e,t&&(this.message=t)}async yieldToUI(){return new Promise(e=>setTimeout(e,30))}finish(e="Ready!"){this.interval&&clearInterval(this.interval),this.current=100,this.onProgress(100,e)}}async function Ie(a){return B?(a&&a(100,"Ready"),B):D?D.then(e=>(a&&a(100,"Ready"),e)):(D=(async()=>{const e=new De(a);e.start();try{e.update(10,"正在啟動 Python 直譯器 (v0.26.4)..."),await Me();let t=null,n=3;for(;n>0;)try{const l="https://cdn.jsdelivr.net/pyodide/v0.26.4/full/";console.log("Using Pyodide CDN for packages:",l),t=await window.loadPyodide({indexURL:l});break}catch(l){if(console.warn(`Failed to load Pyodide (attempts left: ${n-1}):`,l),n--,n===0)throw l;await new Promise(u=>setTimeout(u,1e3))}e.update(25,"引擎啟動完成，正在檢查本地暫存環境..."),await e.yieldToUI();const o="/lib/python3.12/site-packages";try{t.FS.mkdirTree(o)}catch{}t.FS.mount(t.FS.filesystems.IDBFS,{},o),e.update(26,"正在從本地儲存區載入 Python 環境..."),await new Promise(l=>{t.FS.syncfs(!0,u=>{u&&console.error("IDBFS sync error:",u),l()})}),await e.yieldToUI();const d=["numpy","pandas","matplotlib","scipy","statsmodels","sympy","lxml","micropip"],y=["numpy-financial","pandas-datareader","pyodide-http","pymoo==0.4.1","seaborn"],r=t.FS.readdir(o),h=d.filter(l=>!r.includes(l)&&!r.some(u=>u.startsWith(l+"-"))),c=y.filter(l=>{const u=l.replace("-","_");return!r.includes(l)&&!r.includes(u)&&!r.some(w=>w.startsWith(l+"-"))&&!r.some(w=>w.startsWith(u+"-"))});if(h.length>0||c.length>0){const l=[...h,...c];if(e.update(30,`正在同步並安裝套件: ${l.join(", ")}...`),h.length>0&&(e.update(40,`正在從 CDN 獲取核心科學套件 (${h.length} 個)...`),await t.loadPackage(h)),c.length>0){e.update(70,`正在掛載第三方擴充資源 (${c.length} 個)...`),await t.loadPackage("micropip");const u=t.pyimport("micropip"),w=c.map(E=>E==="numpy-financial"?"/pwa_FRM_Book1_python/wheels/numpy_financial-1.0.0-py3-none-any.whl":E);await u.install(w)}e.update(85,"正在固化環境映射至本地磁碟..."),await new Promise(u=>{t.FS.syncfs(!1,w=>{w&&console.error("IDBFS save error:",w),u()})}),e.update(90,"✅ 環境已完成本地持久化儲存")}else e.update(90,"🚀 偵測到本地環境快照，已跳過網路請求");return await e.yieldToUI(),e.update(92,"⚙️ 配置：正在載入環境優化補丁..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(`
import warnings
warnings.simplefilter("ignore", DeprecationWarning)
warnings.simplefilter("ignore", FutureWarning)
warnings.simplefilter("ignore", SyntaxWarning)
...
try:
    ...
    if not hasattr(scipy.stats, 'binom_test') and hasattr(scipy.stats, 'binomtest'):
        ...
        scipy.stats.binom_test = binom_test_shim
                ...
                `)]),await e.yieldToUI(),e.update(98,"🚀 系統：正在啟動 Pymoo & QuantLib 虛擬層..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(Ne),t.runPythonAsync(Le),t.runPythonAsync(Se),t.runPythonAsync(ke),t.runPythonAsync(Ee),t.runPythonAsync(je)]),e.update(99,"🛡️ 系統：權限校正與輸入掛鉤注入..."),await t.runPythonAsync(`
import builtins
import js
def custom_input(prompt = ""):
    try:
...
builtins.input = custom_input
            `),await e.yieldToUI(),B=t,D=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw D=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),D)}async function Fe(a,e,t=3e4){let n;const o=new Promise((d,y)=>{n=setTimeout(()=>{y(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([a.runPythonAsync(e),o])}finally{clearTimeout(n)}}async function Ce(a){if(a)try{await a.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
                `)}catch{}}async function Te(a){try{const e=await a.runPythonAsync(`
import matplotlib.pyplot as plt
len(plt.get_fignums())
    `);if(e===0)return[];const t=[];for(let n=0;n<e;n++){const o=await a.runPythonAsync(`
import matplotlib.pyplot as plt
import io
import base64
...
if plt.style.available and 'default' in plt.style.available:
    ...
    `)}catch(t){console.error("✗ Matplotlib 初始化失敗:",t)}}async function Ae(a){try{await a.runPythonAsync(`
import matplotlib.pyplot as plt
if len(plt.get_fignums()) > 0:
    plt.show()
    `)}catch(e){console.error("Failed to show plots:",e)}}function K(a){const e=a.message||String(a),t=[{pattern:/NameError: name '(.+)' is not defined/,format:n=>`❌ 變數錯誤：'${n[1]}' 未定義
...
• 逐行執行程式碼找出問題
• 使用 print() 輸出變數值
• 簡化程式碼，逐步測試`}class Re{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),n=this.metrics[e].start,o=t-n;return this.metrics[e].end=t,this.metrics[e].duration=o,this.log(e,o),o}log(e,t){const n=t<100?"⚡":t<1e3?"⏱️":"🐌",o=t<100?"color: green":t<1e3?"color: orange":"color: red";console.log(`%c${n} ${e}: ${t.toFixed(2)}ms`,o),t>1e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,n)=>t+n,0),average:e.reduce((t,n)=>t+n,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.log(`總計測量: ${e.count} 次`),console.log(`總時間: ${e.total.toFixed(2)}ms`),console.log(`平均時間: ${e.average.toFixed(2)}ms`),console.log(`最快: ${e.min.toFixed(2)}ms`),console.log(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,n])=>{n.duration!==null&&console.log(`${t}: ${n.duration.toFixed(2)}ms`)}),console.groupEnd()}}const I=new Re;I.setEnabled(!1);let X=!1;function Qe(){if(!X&&(X=!0,"PerformanceObserver"in window)){new PerformanceObserver(o=>{const d=o.getEntries(),y=d[d.length-1];console.log("🎨 LCP:",y.renderTime||y.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(o=>{o.getEntries().forEach(y=>{console.log("⚡ FID:",y.processingStart-y.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(o=>{o.getEntries().forEach(y=>{y.hadRecentInput||(t+=y.value)}),console.log("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const ze=m.lazy(()=>pe(()=>import("./CodePreviewPanel-BAmgNmSY.js"),__vite__mapDeps([0,1,2,3]))),ee={pandas:"pandas",matplotlib:"matplotlib",scipy:"scipy",statsmodels:"statsmodels",sympy:"sympy",autograd:"autograd",lxml:"lxml",openpyxl:"openpyxl",requests:"requests",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",mpl_toolkits:"matplotlib",pylab:"matplotlib"},te={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"};function Be(){const[a,e]=m.useState(null),[t,n]=m.useState(!0),[o,d]=m.useState(0),[y,r]=m.useState("初始化中..."),[h,c]=m.useState([]),[i,l]=m.useState(!0),[u,w]=m.useState(null),[E,b]=m.useState(null),[P,q]=m.useState(""),[C,x]=m.useState(""),[O,$]=m.useState([]),[T,A]=m.useState(!1),[W,se]=m.useState(!1),[j,ae]=m.useState(()=>{const f=localStorage.getItem("theme");return f==="dark"||!f&&!1}),[U,ne]=m.useState(600),[R]=m.useState(new Set),[H,Y]=m.useState(null);m.useEffect(()=>{l(!0);const f=`/pwa_FRM_Book1_python/data/chapters.json?t=${Date.now()}`;fetch(f).then(p=>p.json()).then(p=>{p&&p.length>0&&c(p),l(!1)}).catch(p=>{console.error("Failed to load chapters:",p),l(!1)})},[]),m.useEffect(()=>{Ie((p,_)=>{d(p),r(_)}).then(p=>{e(p),n(!1),I.end("pyodide-init")}),Qe();const f=[];if("serviceWorker"in navigator){const p=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(k=>{k.forEach(S=>S.update())})},36e5),_=()=>{};navigator.serviceWorker.addEventListener("controllerchange",_),f.push(()=>{clearInterval(p),navigator.serviceWorker.removeEventListener("controllerchange",_)})}if("storage"in navigator&&"estimate"in navigator.storage){const p=async()=>{try{const k=await navigator.storage.estimate();k.usage&&k.quota&&k.usage/k.quota*100>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}catch(k){console.warn("Failed to check storage quota:",k)}};p();const _=setInterval(p,300*1e3);f.push(()=>clearInterval(_))}return()=>{f.forEach(p=>p())}},[]),m.useEffect(()=>{localStorage.setItem("theme",j?"dark":"light"),document.documentElement.setAttribute("data-theme",j?"dark":"light")},[j]);const G=async(f,p=!1)=>{var Z;if(!a)return;const _=f.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!_)return;const k=["sys","os","io","time","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib"],S=["numpy","pandas","matplotlib","scipy","statsmodels","sympy","lxml","micropip","js","builtins","QuantLib"],N=[...new Set(_.map(v=>{const g=v.trim().split(/\s+/);return g[0]==="from",g[1].split(".")[0]}))].filter(v=>!k.includes(v)&&!S.includes(v)).filter(v=>!R.has(v));if(N.length===0)return;const M=[],V=new URL("/pwa_FRM_Book1_python/",window.location.origin).href;if(N.forEach(v=>{const g=ee[v];g?(M.push(g.endsWith(".whl")?V+g:g),(te[v]||[]).forEach(F=>{const Q=te[F]||F;M.push(Q.endsWith(".whl")?V+Q:Q)})):M.push(v)}),M.length>0)try{const v=[...new Set(M)];p||x(g=>g+`正在動態載入所需套件 [${N.join(", ")}]...
`),await a.loadPackage("micropip"),await a.runPythonAsync(`
import micropip
await micropip.install(${JSON.stringify(v)}, keep_going=True)
        `),N.includes("matplotlib")&&(await J(a),H||Y("AGG")),N.forEach(g=>{R.add(g);const L=ee[g];L&&!L.endsWith(".whl")&&R.add(L)}),p||x(g=>g+`✅ 套件載入完成。
`)}catch(v){if(console.warn("Dependency loading failed:",v),!p){const g=v.message||String(v);if(g.includes("Can't find a pure Python 3 wheel")){const L=((Z=g.match(/for: '([^']+)'/))==null?void 0:Z[1])||"unknown";x(F=>F+`⚠️ 套件 "${L}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else x(L=>L+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},re=async f=>{if(!(!a||T||!f)){I.start("run-code"),A(!0),x(`執行中...
`),$([]);try{await Ce(a);const p=f.includes("matplotlib.widgets")||f.includes("Slider")||f.includes("Button");se(p);const _=p?"module://matplotlib_pyodide.wasm_backend":"AGG";if(H!==_&&(await J(a,p),Y(_)),await a.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),p){const S=document.getElementById("pyodide-plot-container");S&&(S.innerHTML="",window.document.pyodideMplTarget=S)}await G(f);try{await Fe(a,f)}catch(S){const N=await a.runPythonAsync("sys.stdout.getvalue()"),M=K(S);x((N?N+`
`:"")+M),A(!1),I.end("run-code");return}const k=await a.runPythonAsync("sys.stdout.getvalue()");if(x(k||"執行完成（無文字內容輸出 ）"),W)await Ae(a);else{const S=await Te(a);$(S)}}catch(p){const _=K(p);x(_),console.error(p)}finally{A(!1),I.end("run-code")}}},oe=f=>{if(w(f),b(null),q(""),x(""),$([]),f&&f.examples&&a){const p=f.examples.map(_=>_.code).join(`
`);G(p,!0)}},ie=f=>{b(f),x(""),$([])},le=f=>{b(f),x(""),$([])},de=()=>{b(null),x(""),$([])},ce=t;return s.jsxs("div",{className:`app ${j?"dark":""}`,children:[s.jsxs("div",{className:"main-content",children:[s.jsxs("div",{className:"top-bar",children:[s.jsxs("div",{className:"top-bar-left",children:[s.jsx(me,{size:20,className:"logo-icon"}),s.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),s.jsx(we,{chapters:h,currentChapter:u,onChapterSelect:oe,currentScript:E,onScriptSelect:le,selectedTopicId:P,onTopicSelect:q,loading:i}),s.jsx("div",{className:"top-bar-right",children:s.jsx("button",{className:"theme-toggle",onClick:()=>ae(!j),title:j?"切換到亮色模式":"切換到暗色模式",children:j?s.jsx(ue,{size:20}):s.jsx(fe,{size:20})})})]}),ce&&s.jsx("div",{className:"hydration-overlay",children:s.jsxs("div",{className:"hydration-card",children:[s.jsxs("div",{className:"hydration-header",children:[s.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),s.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),s.jsx("div",{className:"hydration-progress-container",children:s.jsx("div",{className:"hydration-progress-bar",style:{width:`${o}%`}})}),s.jsxs("div",{className:"hydration-status",children:[s.jsx("span",{children:y}),s.jsxs("span",{children:[o,"%"]})]})]})}),s.jsxs("div",{className:"panes-container",children:[s.jsx("div",{className:"content-pane",children:s.jsx(xe,{chapter:u,onCodeClick:ie,selectedTopicId:P,darkMode:j,output:C,isRunning:T,plotImages:O,onClearOutput:()=>{x(""),$([])}})}),E&&s.jsx("div",{className:"preview-pane",style:{width:`${U}px`},children:s.jsx(m.Suspense,{fallback:s.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:s.jsx(ze,{script:E,onClose:de,onRun:re,isRunning:T,isLoading:t,output:C,images:O,isInteractive:W,darkMode:j,width:U,onResize:ne})})})]})]}),s.jsx(Pe,{pyodide:a})]})}ye.createRoot(document.getElementById("root")).render(s.jsx(he.StrictMode,{children:s.jsx(Be,{})}));
