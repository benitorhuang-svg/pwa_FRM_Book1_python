...
import{r as f,j as n,C as V,_ as pe,B as Se,S as Ee,M as Ne,R as je,a as Le}from"./vendor-react-DBlZ22TX.js";import{B as Ae,p as $e}from"./vendor-utils-DahDrsZr.js";import{r as Re}from"./vendor-katex-CrEV6Ds-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const m of o)if(m.type==="childList")for(const i of m.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function t(o){const m={};return o.integrity&&(m.integrity=o.integrity),o.referrerPolicy&&(m.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?m.credentials="include":o.crossOrigin==="anonymous"?m.credentials="omit":m.credentials="same-origin",m}function r(o){if(o.ep)return;o.ep=!0;const m=t(o);fetch(o.href,m)}})();function De({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:r,currentScript:o,onScriptSelect:m,selectedTopicId:i,onTopicSelect:y,loading:b}){var k,d;const l=f.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let c="";const u=a.intro;typeof u=="string"?c=u:u&&typeof u=="object"&&u.body&&(c+=typeof u.body=="string"?u.body:Object.values(u.body).join(`
`));const w=t||a.body;if(w&&(typeof w=="string"?c+=`
`+w:Array.isArray(w)?c+=`
`+w.join(`
`):typeof w=="object"&&(c+=`
`+Object.values(w).join(`
`))),!c)return[];const A=/^###\s+(.+)$/gm,R=[];let T;for(;(T=A.exec(c))!==null;){const M=T[1].trim(),I="topic-"+M.replace(/\s+/g,"-").toLowerCase();R.push({id:I,title:M})}return R},[e,t]);return n.jsxs("div",{className:"top-nav-container",children:[n.jsx("div",{className:"nav-group",children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:a=>{const c=s.find(u=>u.id===a.target.value);c&&r(c)},disabled:b||s.length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:b?"載入中...":"📖 章節選擇"}),s.map(a=>n.jsx("option",{value:a.id,children:a.title},a.id))]}),n.jsx(V,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${!e||l.length===0?"disabled":""}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"topic-select",name:"topic-select",value:i,onChange:a=>y(a.target.value),disabled:!e||l.length===0,className:"custom-select",children:[n.jsx("option",{value:"",children:"💡 重點導覽"}),l.map(a=>n.jsx("option",{value:a.id,children:a.title},a.id))]}),n.jsx(V,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"script-select",name:"script-select",value:(o==null?void 0:o.filename)||"",onChange:a=>{var u;const c=(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples);if(c){const w=c.find(A=>A.filename===a.target.value);w&&m(w)}},disabled:!e||!(e.examples||(k=e.content)!=null&&k.examples)||(e.examples||((d=e.content)==null?void 0:d.examples)||[]).length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var u;return[...(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples)||[]].sort((w,A)=>w.filename.localeCompare(A.filename,void 0,{numeric:!0,sensitivity:"base"})).map(w=>n.jsx("option",{value:w.filename,children:w.filename},w.filename))})()]}),n.jsx(V,{className:"select-icon",size:16})]})})]})}const Me=new Ae,qe=f.memo(({chapter:s,bodyContent:e,onCodeClick:t,selectedTopicId:r,output:o,isRunning:m,plotImages:i})=>{const y=f.useRef(null),b=f.useMemo(()=>{var k,d;if(!s)return null;const l=(k=s.content)==null?void 0:k.intro;if(l){let a="";if(typeof l=="string")a=l;else if(typeof l=="object"){a=`# ${l.title||""}
...
`));const v=e||((d=s.content)==null?void 0:d.body)||l.body;if(v)if(a+=`
...
`);const c=[];a=a.replace(/\$\$([\s\S]*?)\$\$/g,(v,g)=>{const j=c.length;return c.push({type:"display",content:g}),` @@MATH_BLOCK_${j}@@ `}),a=a.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(v,g)=>{const j=c.length;return c.push({type:"display",content:`\\begin{aligned}${g}\\end{aligned}`}),` @@MATH_BLOCK_${j}@@ `}),a=a.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(v,g)=>{const j=c.length;return c.push({type:"inline",content:g}),` @@MATH_BLOCK_${j}@@ `});let w=Me.parse(a).replace(/<h3>(.*?)<\/h3>/g,(v,g)=>`<h3 id="${"topic-"+g.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${g}</h3>`);const A=$e.sanitize(w,{USE_PROFILES:{html:!0,mathml:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display"]}),T=[...s.examples||[]].sort((v,g)=>g.filename.length-v.filename.length);let M=A;return T.forEach(v=>{const g=v.filename.replace(".","\\."),j=new RegExp(`(?<!['".\\w])(${g})(?!['".\\w])`,"g");M=M.replace(j,`<span class="code-link" data-filename="${v.filename}">${v.filename}</span>`)}),M.replace(/@@MATH_BLOCK_(\d+)@@/g,(v,g)=>{const j=c[parseInt(g)];return j.type==="display"?`\\[ ${j.content.trim()} \\]`:`\\( ${j.content.trim()} \\)`})}else{const a=s.examples||[];let c=`
        <div class="chapter-intro">
          <h2>${s.title}</h2>
          <p>本章包含 ${a.length} 個程式範例</p>
          <div class="example-grid">
      `;return a.forEach((u,w)=>{c+=`
      ...
      `,c}},[s,e]);return f.useEffect(()=>{const l=k=>{if(k.target.classList.contains("code-link")){const d=k.target.dataset.filename;let a=null;s!=null&&s.examples&&(a=s.examples.find(c=>c.filename===d),a&&!a.metadata&&(a.metadata={description:a.title})),a&&t(a)}};return document.addEventListener("click",l),()=>document.removeEventListener("click",l)},[s,t]),f.useEffect(()=>{const l=document.querySelector(".content-scroll");l&&(l.scrollTop=0)},[s]),f.useEffect(()=>{y.current&&b&&Re(y.current,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1,strict:"ignore"})},[b]),f.useEffect(()=>{if(r){const l=document.getElementById(r);l&&l.scrollIntoView({behavior:"smooth",block:"start"})}},[r]),f.useEffect(()=>{if(o||i&&i.length>0||m){const l=document.querySelector(".content-scroll");l&&l.scrollTo({top:0,behavior:"instant"})}},[o,i,m]),n.jsx("div",{className:"content-panel",children:n.jsx("div",{className:"content-scroll",children:o||i&&i.length>0||m?n.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[m&&n.jsxs("div",{className:"running-indicator",children:[n.jsx("div",{className:"spinner"}),n.jsx("span",{children:"程式執行中..."})]}),o&&n.jsx("pre",{className:"output-text",children:o}),i&&i.length>0&&n.jsx("div",{className:"output-images",children:i.map((l,k)=>n.jsx("div",{className:"output-image",children:n.jsx("img",{src:l,alt:`Plot ${k+1}`})},k))})]}):b?n.jsx("div",{ref:y,className:"markdown-body",dangerouslySetInnerHTML:{__html:b}}):n.jsx("div",{className:"welcome-screen",children:n.jsxs("div",{className:"welcome-card premium-welcome",children:[n.jsxs("div",{className:"welcome-brand",children:[n.jsx("img",{src:"book-cover.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),n.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%9f%ba%e7%a4%8e%e7%af%87dm2301/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),n.jsxs("div",{className:"welcome-content",children:[n.jsxs("h2",{className:"welcome-title",children:["手術刀般精準的 FRM 用 Python",n.jsx("br",{}),"科學管控財金風險：基礎篇"]}),n.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),n.jsxs("div",{className:"welcome-text-scroll",children:[n.jsx("p",{children:"本書使用了當紅的程式語言 Python，從程式設計的基本觀念談起。沒有 Python 基礎也沒關係，完整的 Python 介紹，讓您能順利銜接資料科學家最常用的套件整理，包括 Numpy，以及特別針對格式化表格類處理的 Pandas，也充分介紹了 Dataframe 的各種應用。"}),n.jsx("p",{children:"在有了充足的資料之後，接著需要有可以展示數據的工具。除了大家最愛用的 Matplotlib 之外，也介紹了高手才會用的 Seaborn。當熟悉了工具之後，就正式進入了金融理論，包括基礎的機率及統計、各種模型及機率分佈，以及抽樣、信賴區間等內容說明。"}),n.jsx("p",{children:"最後則進入到金融領域，除了介紹各種計算的演算法、模型、術語，也結合了前面所學的 Python 及工具，並講解金融商品最重要的「固定收益分析」。"}),n.jsx("p",{children:"本書從科學下手，讓您精準了解金融原理，確保金錢不再陷入水深火熱之中，將是您從科學到金融領域最重要的橋樑。"})]})]})]})})})})});function Te(){return null}function Ce(s={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:r,onRegistered:o,onRegisteredSW:m,onRegisterError:i}=s;let y,b,l;const k=async(a=!0)=>{await b,l==null||l()};async function d(){if("serviceWorker"in navigator){if(y=await pe(async()=>{const{Workbox:a}=await import("./vendor-B3CQIlJd.js").then(c=>c.w);return{Workbox:a}},[]).then(({Workbox:a})=>new a("/pwa_FRM_Book1_python/sw.js",{scope:"/pwa_FRM_Book1_python/",type:"classic"})).catch(a=>{i==null||i(a)}),!y)return;l=()=>{y==null||y.messageSkipWaiting()};{let a=!1;const c=()=>{a=!0,y==null||y.addEventListener("controlling",u=>{u.isUpdate&&window.location.reload()}),t==null||t()};y.addEventListener("installed",u=>{typeof u.isUpdate>"u"?typeof u.isExternal<"u"&&u.isExternal?c():!a&&(r==null||r()):u.isUpdate||r==null||r()}),y.addEventListener("waiting",c)}y.register({immediate:e}).then(a=>{m?m("/pwa_FRM_Book1_python/sw.js",a):o==null||o(a)}).catch(a=>{i==null||i(a)})}}return b=d(),k}function Fe(s={}){const{immediate:e=!0,onNeedRefresh:t,onOfflineReady:r,onRegistered:o,onRegisteredSW:m,onRegisterError:i}=s,[y,b]=f.useState(!1),[l,k]=f.useState(!1),[d]=f.useState(()=>Ce({immediate:e,onOfflineReady(){k(!0),r==null||r()},onNeedRefresh(){b(!0),t==null||t()},onRegistered:o,onRegisteredSW:m,onRegisterError:i}));return{needRefresh:[y,b],offlineReady:[l,k],updateServiceWorker:d}}function Ie(){const{offlineReady:[s,e],needRefresh:[t,r],updateServiceWorker:o}=Fe({onRegisteredSW(i,y){console.debug(`Service Worker at: ${i}`),y&&setInterval(()=>{y.update()},36e5)},onRegisterError(i){console.warn("SW registration error",i)}}),m=()=>{e(!1),r(!1)};return n.jsx("div",{className:"ReloadPrompt-container",children:(s||t)&&n.jsxs("div",{className:"ReloadPrompt-toast",children:[n.jsx("div",{className:"ReloadPrompt-message",children:s?"App ready to work offline":"New content available, click on reload button to update."}),t&&n.jsx("button",{className:"ReloadPrompt-toast-button",onClick:()=>o(!0),children:"Reload"}),n.jsx("button",{className:"ReloadPrompt-toast-button",onClick:m,children:"Close"})]})})}function Be(s){const[e,t]=f.useState(null),[r,o]=f.useState(!1),m=f.useRef({});return f.useEffect(()=>{if(!s){t(null);return}const i=s.content,y=s.id;if(i!=null&&i.body&&!(i!=null&&i.bodyRef)){t(i.body);return}const b=i==null?void 0:i.bodyRef;if(!b||!Array.isArray(b)||b.length===0){t(null);return}let l=!1;return o(!0),(async()=>{const d={};await Promise.all(b.map(async a=>{const c=`${y}/${a}`;if(m.current[c]!==void 0){d[a]=m.current[c];return}try{const u=`/pwa_FRM_Book1_python/data/modular/${y}/${a}.json`,w=await fetch(u);if(!w.ok)throw new Error(`HTTP ${w.status}`);const R=(await w.json()).content||"";m.current[c]=R,d[a]=R}catch(u){console.warn(`[useBodyContent] Failed to load ${y}/${a}:`,u),d[a]=""}})),l||(t(d),o(!1))})(),()=>{l=!0}},[s]),{bodyContent:e,bodyLoading:r}}const me=`
# QuantLib (ql) 強大模擬層
...
try:
    ...
    pass
`;let Y=null,F=null;const Ue=["https://cdn.jsdelivr.net/pyodide/v0.26.4/full/pyodide.js","https://unpkg.com/pyodide@0.26.4/pyodide.js"];function He(s){return new Promise((e,t)=>{const r=document.createElement("script");r.src=s,r.crossOrigin="anonymous",r.onload=e,r.onerror=()=>t(new Error(`Failed to load script: ${s}`)),document.head.appendChild(r)})}async function Ge(){if(typeof window.loadPyodide!="function"){console.warn("window.loadPyodide not found, loading dynamically...");for(const s of Ue)try{if(await He(s),typeof window.loadPyodide=="function"){console.log(`Pyodide loaded from ${s}`);return}}catch(e){console.warn(`Failed to load Pyodide from ${s}:`,e.message)}throw new Error("Failed to load Pyodide from all CDN sources")}}class Ve{constructor(e){this.onProgress=e,this.current=0,this.target=0,this.message="",this.interval=null,this.step=.1}start(){this.interval||(this.interval=setInterval(()=>{if(this.current<this.target){const e=this.target-this.current,t=e>20?3.5:e>5?1.5:.5;this.current=Math.min(this.current+t,this.target),this.onProgress(Math.floor(this.current),this.message)}else this.target<99&&(this.current=Math.min(this.current+.08,99.9),this.onProgress(Math.floor(this.current),this.message))},100))}update(e,t){this.target=e,t&&(this.message=t)}async yieldToUI(){return new Promise(e=>setTimeout(e,30))}finish(e="Ready!"){this.interval&&clearInterval(this.interval),this.current=100,this.onProgress(100,e)}}async function Ye(s){return Y?(s&&s(100,"Ready"),Y):F?F.then(e=>(s&&s(100,"Ready"),e)):(F=(async()=>{const e=new Ve(s);e.start();try{e.update(10,"正在啟動 Python 直譯器 (v0.26.4)..."),await Ge();let t=null,r=3;for(;r>0;)try{const d="https://cdn.jsdelivr.net/pyodide/v0.26.4/full/";console.log("Using Pyodide CDN for packages:",d),t=await window.loadPyodide({indexURL:d});break}catch(d){if(console.warn(`Failed to load Pyodide (attempts left: ${r-1}):`,d),r--,r===0)throw d;await new Promise(a=>setTimeout(a,1e3))}try{const d=document.getElementById("inline-scipy-stub");if(d&&d.textContent&&d.textContent.trim().length>0)try{await t.runPythonAsync(d.textContent),console.log("Inline SciPy stub executed early.")}catch(a){console.warn("Failed to execute inline SciPy stub:",a)}}catch(d){console.warn("Error checking inline SciPy stub:",d)}e.update(25,"引擎啟動完成，正在檢查本地暫存環境..."),await e.yieldToUI();const o="/lib/python3.12/site-packages";try{t.FS.mkdirTree(o)}catch{}t.FS.mount(t.FS.filesystems.IDBFS,{},o),e.update(26,"正在從本地儲存區載入 Python 環境..."),await new Promise(d=>{t.FS.syncfs(!0,a=>{a&&console.error("IDBFS sync error:",a),d()})}),await e.yieldToUI();const m=["numpy","pandas","matplotlib","scipy","statsmodels","sympy","lxml","micropip"],i=["numpy-financial","pandas-datareader","pyodide-http","pymoo==0.4.1","seaborn"],y=t.FS.readdir(o),b=m.filter(d=>!y.includes(d)&&!y.some(a=>a.startsWith(d+"-"))),l=i.filter(d=>{const a=d.replace("-","_");return!y.includes(d)&&!y.includes(a)&&!y.some(c=>c.startsWith(d+"-"))&&!y.some(c=>c.startsWith(a+"-"))});if(b.length>0||l.length>0){const d=[...b,...l];if(e.update(30,`正在同步並安裝套件: ${d.join(", ")}...`),b.length>0&&(e.update(40,`正在從 CDN 獲取核心科學套件 (${b.length} 個)...`),await t.loadPackage(b)),l.length>0){e.update(70,`正在掛載第三方擴充資源 (${l.length} 個)...`),await t.loadPackage("micropip");const a=t.pyimport("micropip"),c=l.map(u=>u==="numpy-financial"?"/pwa_FRM_Book1_python/wheels/numpy_financial-1.0.0-py3-none-any.whl":u);await a.install(c)}e.update(85,"正在固化環境映射至本地磁碟..."),await new Promise(a=>{t.FS.syncfs(!1,c=>{c&&console.error("IDBFS save error:",c),a()})}),e.update(90,"✅ 環境已完成本地持久化儲存")}else e.update(90,"🚀 偵測到本地環境快照，已跳過網路請求");return await e.yieldToUI(),e.update(92,"⚙️ 配置：正在載入環境優化補丁..."),await e.yieldToUI(),await Promise.all([t.runPythonAsync(`
import warnings
warnings.simplefilter("ignore", DeprecationWarning)
warnings.simplefilter("ignore", FutureWarning)
warnings.simplefilter("ignore", SyntaxWarning)
...
builtins.input = custom_input
            `),await e.yieldToUI(),Y=t,F=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw F=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),F)}async function Ke(s,e,t=3e4){let r;const o=new Promise((m,i)=>{r=setTimeout(()=>{i(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([s.runPythonAsync(e),o])}finally{clearTimeout(r)}}async function Je(s){if(s)try{await s.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
                `)}catch{}}const re=new Set;async function oe(s,e){!s||!e||re.has(e)||re.add(e)}async function Ze(s){if(s)try{await s.loadPackage("micropip");const e=s.pyimport("micropip"),t=["/pwa_FRM_Book1_python/wheels/pymoo-0.4.1-py3-none-any.whl","/pwa_FRM_Book1_python/wheels/pandas_datareader-0.10.0-py3-none-any.whl","/pwa_FRM_Book1_python/wheels/pyodide_http-0.2.2-py3-none-any.whl","/pwa_FRM_Book1_python/wheels/seaborn-0.13.2-py3-none-any.whl"];await e.install(t,{transient:!0}).catch(r=>{console.warn("preloadHeavyPackages pip install failed",r)})}catch(e){console.warn("preloadHeavyPackages error",e)}}async function Xe(s){try{const e=await s.runPythonAsync(`
import matplotlib.pyplot as plt
len(plt.get_fignums())
    `);if(e===0)return[];const t=[];for(let r=0;r<e;r++){const o=await s.runPythonAsync(`
import matplotlib.pyplot as plt
import io
import base64
...
if len(plt.get_fignums()) > 0:
    plt.show()
    `)}catch(e){console.error("Failed to show plots:",e)}}function le(s){const e=s.message||String(s),t=[{pattern:/NameError: name '(.+)' is not defined/,format:r=>`❌ 變數錯誤：'${r[1]}' 未定義
...
• 在除法前檢查除數是否為零
• 使用 if 語句避免除以零
• 檢查資料中是否有零值`},{pattern:/ImportError: (.+)/,format:r=>`❌ 匯入錯誤：${r[1]}
...
• 確認模組名稱正確
• 檢查是否支援該模組
• 查看完整錯誤訊息了解詳情`}];for(const{pattern:r,format:o}of t){const m=e.match(r);if(m)return o(m)}return`❌ 執行錯誤
...
• 逐行執行程式碼找出問題
• 使用 print() 輸出變數值
• 簡化程式碼，逐步測試`}class tt{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),r=this.metrics[e].start,o=t-r;return this.metrics[e].end=t,this.metrics[e].duration=o,this.log(e,o),o}log(e,t){const r=t<100?"⚡":t<1e3?"⏱️":"🐌",o=t<100?"color: green":t<1e3?"color: orange":"color: red";console.log(`%c${r} ${e}: ${t.toFixed(2)}ms`,o),t>1e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,r)=>t+r,0),average:e.reduce((t,r)=>t+r,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.log(`總計測量: ${e.count} 次`),console.log(`總時間: ${e.total.toFixed(2)}ms`),console.log(`平均時間: ${e.average.toFixed(2)}ms`),console.log(`最快: ${e.min.toFixed(2)}ms`),console.log(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,r])=>{r.duration!==null&&console.log(`${t}: ${r.duration.toFixed(2)}ms`)}),console.groupEnd()}}const z=new tt;z.setEnabled(!1);let ce=!1;function at(){if(!ce&&(ce=!0,"PerformanceObserver"in window)){new PerformanceObserver(o=>{const m=o.getEntries(),i=m[m.length-1];console.log("🎨 LCP:",i.renderTime||i.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(o=>{o.getEntries().forEach(i=>{console.log("⚡ FID:",i.processingStart-i.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(o=>{o.getEntries().forEach(i=>{i.hadRecentInput||(t+=i.value)}),console.log("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const st=f.lazy(()=>pe(()=>import("./CodePreviewPanel-DcyHY-xF.js"),__vite__mapDeps([0,1,2,3]))),K={QuantLib:"QuantLib",arch:"arch",autograd:"autograd",chart_studio:"chart-studio",datetime:"datetime",lxml:"lxml",math:"math",matplotlib:"matplotlib",mcint:"mcint",mibian:"mibian",mpl_toolkits:"matplotlib",numpy:"numpy",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",openpyxl:"openpyxl",pandas:"pandas",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",plotly:"plotly",prettytable:"prettytable",pylab:"matplotlib",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",qpsolvers:"qpsolvers",requests:"requests","scikit-learn":"scikit-learn",scipy:"scipy",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",sklearn:"scikit-learn",statsmodels:"statsmodels",sympy:"sympy",tabulate:"tabulate"},de={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"};typeof window<"u"&&"serviceWorker"in navigator&&(async()=>{try{const s=`/pwa_FRM_Book1_python/manifest.webmanifest?t=${Date.now()}`,e=`/pwa_FRM_Book1_python/assets-manifest.json?t=${Date.now()}`;let t=null;try{const i=await fetch(s,{cache:"no-store"});i&&i.ok&&(t=await i.text())}catch{}if(!t)try{const i=await fetch(e,{cache:"no-store"});if(!i||!i.ok)return;t=await i.text()}catch{return}const r=localStorage.getItem("app_assets_manifest_text");if(r&&r===t)return;localStorage.setItem("app_assets_manifest_text",t);const o=await navigator.serviceWorker.getRegistrations();if(!o||o.length===0){localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),location.reload());return}for(const i of o)try{await i.update(),i.waiting&&i.waiting.postMessage({type:"SKIP_WAITING"})}catch(y){console.warn("SW update attempt failed:",y)}const m=()=>{localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),window.location.reload())};navigator.serviceWorker.addEventListener("controllerchange",m)}catch(s){console.warn("Version check/update failed:",s)}})();function nt(){const[s,e]=f.useState(null),[t,r]=f.useState(!0),[o,m]=f.useState(0),[i,y]=f.useState("初始化中..."),[b,l]=f.useState([]),[k,d]=f.useState(!0),[a,c]=f.useState(null),[u,w]=f.useState(null),[A,R]=f.useState(""),[T,M]=f.useState({}),{bodyContent:I}=Be(a),[v,g]=f.useState(""),[j,q]=f.useState([]),[W,U]=f.useState(!1),[J,ue]=f.useState(!1),[D,ye]=f.useState(()=>{const h=localStorage.getItem("theme");return h==="dark"||!h&&!1}),[Z,he]=f.useState(600),[C]=f.useState(new Set),[X,ee]=f.useState(null),te=f.useRef(!1);f.useEffect(()=>{d(!0);const h=`/pwa_FRM_Book1_python/data/chapters_index.json?t=${Date.now()}`;fetch(h).then(p=>p.json()).then(p=>{p&&p.length>0&&l(p),d(!1)}).catch(p=>{console.error("Failed to load chapters index:",p),d(!1)})},[]);const ge=async h=>{if(T[h])return T[h];try{d(!0);const p=await fetch(`/pwa_FRM_Book1_python/data/chapters_${h}.json?t=${Date.now()}`);if(!p.ok)throw new Error(`HTTP error! status: ${p.status}`);const P=await p.text();let S=null;try{S=JSON.parse(P)}catch{try{const E=P.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");S=JSON.parse(E)}catch(E){throw new Error(`Failed to parse chapter data: ${E.message}`)}}return M(E=>({...E,[h]:S})),d(!1),S}catch(p){return console.error(`Failed to load chapter ${h}:`,p),d(!1),null}};f.useEffect(()=>{Ye((p,P)=>{m(p),y(P)}).then(p=>{e(p),r(!1),z.end("pyodide-init")}),at();const h=[];if("serviceWorker"in navigator){const p=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(S=>{S.forEach(E=>E.update())})},36e5),P=()=>{};navigator.serviceWorker.addEventListener("controllerchange",P),h.push(()=>{clearInterval(p),navigator.serviceWorker.removeEventListener("controllerchange",P)})}if("storage"in navigator&&"estimate"in navigator.storage){const p=async()=>{try{const S=await navigator.storage.estimate();S.usage&&S.quota&&S.usage/S.quota*100>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}catch(S){console.warn("Failed to check storage quota:",S)}};p();const P=setInterval(p,300*1e3);h.push(()=>clearInterval(P))}return()=>{h.forEach(p=>p())}},[]),f.useEffect(()=>{s&&!t&&Ze(s).then(()=>{te.current||(te.current=!0,console.warn("Background initialization complete"))}).catch(h=>console.error("Background loaded failed",h))},[s,t]),f.useEffect(()=>{localStorage.setItem("theme",D?"dark":"light"),document.documentElement.setAttribute("data-theme",D?"dark":"light")},[D]);const ae=async(h,p=!1)=>{var ne;if(!s)return;const P=h.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!P)return;if(/^\s*(?:from|import)\s+QuantLib\b/m.test(h)&&!C.has("QuantLib"))try{p||g(_=>_+`正在啟用 QuantLib 相容性墊片...
`),await s.runPythonAsync(me),C.add("QuantLib"),p||g(_=>_+`✅ QuantLib 墊片已啟用。
`)}catch(_){console.warn("QuantLib shim injection failed:",_),p||g(x=>x+`⚠️ QuantLib 墊片啟用失敗，將嘗試繼續執行...
`)}const S=["sys","os","io","time","timeit","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib","fractions","struct","operator","string","decimal","abc","enum","typing","textwrap"],E=["numpy","pandas","matplotlib","micropip","js","builtins","QuantLib","mcint","arch","mibian"],$=[...new Set(P.map(_=>{const x=_.trim().split(/\s+/);return x[0]==="from",x[1].split(".")[0]}))].filter(_=>!S.includes(_)&&!E.includes(_)).filter(_=>{var x;return!C.has(_)&&!((x=window.failedPackages)!=null&&x.has(_))});if($.length===0)return;const B=[],O=[],H=new URL("/pwa_FRM_Book1_python/",window.location.origin).href,Pe=new Set(["scipy","statsmodels","scikit-learn","sympy"]),Q=_=>{if(_){if(typeof _=="string"&&(_.endsWith(".whl")||_.startsWith("http"))){O.push(_);return}Pe.has(_)?B.push(_):O.push(_)}},se={sklearn:["scipy","scikit-learn"],"scikit-learn":["scipy"],statsmodels:["scipy"],sympy:[],seaborn:["matplotlib","pandas","scipy","statsmodels"],pandas_datareader:["requests"]};if($.forEach(_=>{const x=K[_];x?(Q(x.endsWith(".whl")?H+x:x),(de[_]||[]).forEach(L=>{const G=de[L]||L;Q(G.endsWith(".whl")?H+G:G)})):Q(_),se[_]&&se[_].forEach(N=>{if(!C.has(N)&&!E.includes(N)){const L=K[N]||N;Q(L.endsWith(".whl")?H+L:L)}})}),B.length>0||O.length>0)try{const _=[...new Set(B)],x=[...new Set(O)];p||g(N=>N+`正在動態載入所需套件 [${$.join(", ")}]...
...
await micropip.install(${JSON.stringify(x)}, keep_going=True)
          `)),$.includes("pandas_datareader")&&await s.runPythonAsync(fe),$.includes("matplotlib")&&(await ie(s),X||ee("AGG")),$.forEach(N=>{C.add(N);const L=K[N];L&&!L.endsWith(".whl")&&C.add(L)}),p||g(N=>N+`✅ 套件載入完成。
`)}catch(_){if(console.warn("Dependency loading failed:",_),window.failedPackages||(window.failedPackages=new Set),$.forEach(x=>window.failedPackages.add(x)),!p){const x=_.message||String(_);if(x.includes("Can't find a pure Python 3 wheel")){const N=((ne=x.match(/for: '([^']+)'/))==null?void 0:ne[1])||"unknown";g(L=>L+`⚠️ 套件 "${N}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else g(N=>N+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},_e=async h=>{if(!(!s||W||!h)){U(!0),g(`執行中...
`),q([]);try{a&&a.id&&await oe(s,a.id),await ae(h),z.start("run-code"),await Je(s);const p=h.includes("matplotlib.widgets")||h.includes("Slider")||h.includes("Button");ue(p);const P=p?"module://matplotlib_pyodide.wasm_backend":"AGG";if(X!==P&&(await ie(s,p),ee(P)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),p){const E=document.getElementById("pyodide-plot-container");E&&(E.innerHTML="",window.document.pyodideMplTarget=E)}try{await Ke(s,h)}catch(E){const $=await s.runPythonAsync("sys.stdout.getvalue()"),B=le(E);g(($?$+`
`:"")+B),U(!1),z.end("run-code");return}const S=await s.runPythonAsync("sys.stdout.getvalue()");if(g(S||"執行完成（無文字內容輸出 ）"),J)await et(s);else{const E=await Xe(s);q(E)}}catch(p){const P=le(p);g(P),console.error(p)}finally{U(!1),z.end("run-code")}}},we=async h=>{let p=h;if(h&&!h.content&&(p=await ge(h.id)),!!p&&(c(p),w(null),R(""),g(""),q([]),p&&p.examples&&s)){const P=p.examples.map(S=>S.code).join(`
`);ae(P,!0)}};f.useEffect(()=>{s&&a&&a.id&&oe(s,a.id).catch(h=>console.error("Dataset lazy load failed",h))},[s,a]);const be=h=>{w(h),g(""),q([])},ve=h=>{w(h),g(""),q([])},xe=()=>{w(null),g(""),q([])},ke=t;return n.jsxs("div",{className:`app ${D?"dark":""}`,children:[n.jsxs("div",{className:"main-content",children:[n.jsxs("div",{className:"top-bar",children:[n.jsxs("div",{className:"top-bar-left",children:[n.jsx(Se,{size:20,className:"logo-icon"}),n.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),n.jsx(De,{chapters:b,currentChapter:a,bodyContent:I,onChapterSelect:we,currentScript:u,onScriptSelect:ve,selectedTopicId:A,onTopicSelect:R,loading:k}),n.jsx("div",{className:"top-bar-right",children:n.jsx("button",{className:"theme-toggle",onClick:()=>ye(!D),title:D?"切換到亮色模式":"切換到暗色模式",children:D?n.jsx(Ee,{size:20}):n.jsx(Ne,{size:20})})})]}),ke&&n.jsx("div",{className:"hydration-overlay",children:n.jsxs("div",{className:"hydration-card",children:[n.jsxs("div",{className:"hydration-header",children:[n.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),n.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),n.jsx("div",{className:"hydration-progress-container",children:n.jsx("div",{className:"hydration-progress-bar",style:{width:`${o}%`}})}),n.jsxs("div",{className:"hydration-status",children:[n.jsx("span",{children:i}),n.jsxs("span",{children:[o,"%"]})]})]})}),n.jsxs("div",{className:"panes-container",children:[n.jsx("div",{className:"content-pane",children:n.jsx(qe,{chapter:a,bodyContent:I,onCodeClick:be,selectedTopicId:A,darkMode:D,output:v,isRunning:W,plotImages:j,onClearOutput:()=>{g(""),q([])}})}),u&&n.jsx("div",{className:"preview-pane",style:{width:`${Z}px`},children:n.jsx(f.Suspense,{fallback:n.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:n.jsx(st,{script:u,onClose:xe,onRun:_e,isRunning:W,isLoading:t,output:v,images:j,isInteractive:J,darkMode:D,width:Z,onResize:he})})})]})]}),n.jsx(Te,{pyodide:s}),n.jsx(Ie,{})]})}async function rt(){try{if(!("serviceWorker"in navigator))return;const s="frm_sw_cleanup_done_v1";if(localStorage.getItem(s))return;if(!navigator.serviceWorker.controller){localStorage.setItem(s,"1");return}console.info("[AUTO-CLEAN] Detected active Service Worker — cleaning caches and storage.");try{const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(t=>t.unregister().catch(()=>{}))),console.info("[AUTO-CLEAN] serviceWorker registrations unregistered.")}catch(e){console.warn("[AUTO-CLEAN] Failed to unregister service workers",e)}try{if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>caches.delete(t).catch(()=>{}))),console.info("[AUTO-CLEAN] CacheStorage cleared:",e)}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear CacheStorage",e)}try{if("databases"in indexedDB){const e=await indexedDB.databases();await Promise.all(e.map(t=>indexedDB.deleteDatabase(t.name).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB databases deleted:",e.map(t=>t.name))}else{const e=["pyodide","emscripten-archives","idb-filesystem","file_storage"];await Promise.all(e.map(t=>indexedDB.deleteDatabase(t).catch(()=>{}))),console.info("[AUTO-CLEAN] IndexedDB fallback delete attempted for candidates.")}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear IndexedDB",e)}try{localStorage.clear(),sessionStorage.clear(),console.info("[AUTO-CLEAN] localStorage and sessionStorage cleared.")}catch(e){console.warn("[AUTO-CLEAN] Failed to clear storage",e)}try{localStorage.setItem(s,"1")}catch{}try{console.info("[AUTO-CLEAN] Reloading page to load fresh assets."),window.location.reload(!0)}catch(e){console.info("[AUTO-CLEAN] Reload skipped.",e)}}catch(s){console.warn("[AUTO-CLEAN] Unexpected error",s)}}rt().catch(()=>{});je.createRoot(document.getElementById("root")).render(n.jsx(Le.StrictMode,{children:n.jsx(nt,{})}));
