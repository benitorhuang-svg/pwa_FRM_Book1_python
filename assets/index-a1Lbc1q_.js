...
builtins.input = custom_input
            `),await e.yieldToUI(),O=t,D=null,e.finish("載入完成！正在進入主介面..."),t}catch(t){throw D=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),D)}async function qe(s,e,t=3e4){let n;const o=new Promise((d,h)=>{n=setTimeout(()=>{h(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([s.runPythonAsync(e),o])}finally{clearTimeout(n)}}async function $e(s){if(s)try{await s.runPythonAsync(`
            import gc
import matplotlib.pyplot as plt
            plt.close('all')
            gc.collect()
                `)}catch{}}async function Me(s){try{const e=await s.runPythonAsync(`
import matplotlib.pyplot as plt
len(plt.get_fignums())
...
`),$([]);try{await $e(s);const m=f.includes("matplotlib.widgets")||f.includes("Slider")||f.includes("Button");ae(m);const _=m?"module://matplotlib_pyodide.wasm_backend":"AGG";if(H!==_&&(await J(s,m),G(_)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),m){const j=document.getElementById("pyodide-plot-container");j&&(j.innerHTML="",window.document.pyodideMplTarget=j)}await V(f);try{await qe(s,f)}catch(j){const L=await s.runPythonAsync("sys.stdout.getvalue()"),M=K(j);x((L?L+`
`:"")+M),R(!1),F.end("run-code");return}const S=await s.runPythonAsync("sys.stdout.getvalue()");if(x(S||"執行完成（無文字內容輸出 ）"),U)await De(s);else{const j=await Me(s);$(j)}}catch(m){const _=K(m);x(_),console.error(m)}finally{R(!1),F.end("run-code")}}},oe=f=>{if(w(f),b(null),q(""),x(""),$([]),f&&f.examples&&s){const m=f.examples.map(_=>_.code).join(`
`);V(m,!0)}},ie=f=>{b(f),x(""),$([])},le=f=>{b(f),x(""),$([])},de=()=>{b(null),x(""),$([])},ce=t;return a.jsxs("div",{className:`app ${E?"dark":""}`,children:[a.jsxs("div",{className:"main-content",children:[a.jsxs("div",{className:"top-bar",children:[a.jsxs("div",{className:"top-bar-left",children:[a.jsx(pe,{size:20,className:"logo-icon"}),a.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),a.jsx(we,{chapters:y,currentChapter:u,onChapterSelect:oe,currentScript:k,onScriptSelect:le,selectedTopicId:P,onTopicSelect:q,loading:i}),a.jsx("div",{className:"top-bar-right",children:a.jsx("button",{className:"theme-toggle",onClick:()=>se(!E),title:E?"切換到亮色模式":"切換到暗色模式",children:E?a.jsx(ue,{size:20}):a.jsx(fe,{size:20})})})]}),ce&&a.jsx("div",{className:"hydration-overlay",children:a.jsxs("div",{className:"hydration-card",children:[a.jsxs("div",{className:"hydration-header",children:[a.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),a.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),a.jsx("div",{className:"hydration-progress-container",children:a.jsx("div",{className:"hydration-progress-bar",style:{width:`${o}%`}})}),a.jsxs("div",{className:"hydration-status",children:[a.jsx("span",{children:h}),a.jsxs("span",{children:[o,"%"]})]})]})}),a.jsxs("div",{className:"panes-container",children:[a.jsx("div",{className:"content-pane",children:a.jsx(xe,{chapter:u,onCodeClick:ie,selectedTopicId:P,darkMode:E,output:C,isRunning:T,plotImages:W,onClearOutput:()=>{x(""),$([])}})}),k&&a.jsx("div",{className:"preview-pane",style:{width:`${z}px`},children:a.jsx(p.Suspense,{fallback:a.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:a.jsx(Ce,{script:k,onClose:de,onRun:re,isRunning:T,isLoading:t,output:C,images:W,isInteractive:U,darkMode:E,width:z,onResize:ne})})})]})]}),a.jsx(Pe,{pyodide:s})]})}he.createRoot(document.getElementById("root")).render(a.jsx(ye.StrictMode,{children:a.jsx(Te,{})}));
