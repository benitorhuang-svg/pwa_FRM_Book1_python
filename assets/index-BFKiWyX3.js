...
import{j as s,C as Y,r as d,_ as ie,B as le,S as de,M as ce,R as me,a as pe}from"./vendor-react-DZK0ENpr.js";import{d as K,m as ue,p as fe}from"./vendor-utils-BnrmxJWI.js";import"./vendor--_apzOuR.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const m of o.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&n(m)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();function ge({chapters:a,currentChapter:e,onChapterSelect:t,currentScript:n,onScriptSelect:r,loading:o}){var m;return s.jsxs("div",{className:"top-nav-container",children:[s.jsxs("div",{className:"nav-group",children:[s.jsx("label",{className:"nav-label",htmlFor:"chapter-select",children:"章節 Selection"}),s.jsxs("div",{className:"custom-select-wrapper",children:[s.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:u=>{const c=a.find(f=>f.id===u.target.value);c&&t(c)},disabled:o||a.length===0,className:"custom-select",children:[s.jsx("option",{value:"",disabled:!0,children:o?"載入中...":"請選擇章節..."}),a.map(u=>s.jsx("option",{value:u.id,children:u.title},u.id))]}),s.jsx(Y,{className:"select-icon",size:16})]})]}),s.jsxs("div",{className:`nav-group ${e?"":"disabled"}`,children:[s.jsx("label",{className:"nav-label",htmlFor:"script-select",children:"代碼 Code"}),s.jsxs("div",{className:"custom-select-wrapper",children:[s.jsxs("select",{id:"script-select",name:"script-select",value:(n==null?void 0:n.filename)||"",onChange:u=>{if(e!=null&&e.examples){const c=e.examples.find(f=>f.filename===u.target.value);c&&r(c)}},disabled:!e||!e.examples,className:"custom-select",children:[s.jsx("option",{value:"",disabled:!0,children:"選擇程式碼..."}),(m=e==null?void 0:e.examples)==null?void 0:m.map(u=>s.jsx("option",{value:u.filename,children:u.filename},u.filename))]}),s.jsx(Y,{className:"select-icon",size:16})]})]})]})}const he={throwOnError:!1,displayMode:!1,nonStandardPlaceholder:!0};K.use(ue(he));const ye=d.memo(({chapter:a,onCodeClick:e,darkMode:t,output:n,isRunning:r,plotImages:o,onClearOutput:m})=>{const u=d.useMemo(()=>{var c;if(!a)return null;if((c=a.content)!=null&&c.intro){let f=a.content.intro.replace(/##\s*💻\s*應用場景清單[\s\S]*?(?=##|$)/g,"");const P=K.parse(f);let w=fe.sanitize(P,{ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span"],ADD_ATTR:["target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width"]});return[...a.examples||[]].sort((x,j)=>j.filename.length-x.filename.length).forEach(x=>{const j=x.filename.replace(".","\\."),_=new RegExp(`(?<!['"\\w\\.])(${j})(?!['"\\w\\.])`,"g");w=w.replace(_,`<span class="code-link" data-filename="${x.filename}">${x.filename}</span>`)}),w}else{const f=a.examples||[];let P=`
        <div class="chapter-intro">
          <h2>${a.title}</h2>
          <p>本章包含 ${f.length} 個程式範例</p>
          <div class="example-grid">
      `;return f.forEach((g,w)=>{P+=`
      ...
      `,P}},[a]);return d.useEffect(()=>{const c=f=>{if(f.target.classList.contains("code-link")){const P=f.target.dataset.filename;let g=null;a!=null&&a.examples&&(g=a.examples.find(w=>w.filename===P),g&&!g.metadata&&(g.metadata={description:g.title})),g&&e(g)}};return document.addEventListener("click",c),()=>document.removeEventListener("click",c)},[a,e]),d.useEffect(()=>{const c=document.querySelector(".content-scroll");c&&(c.scrollTop=0)},[a]),d.useEffect(()=>{if(n||o&&o.length>0||r){const c=document.querySelector(".content-scroll");c&&c.scrollTo({top:0,behavior:"instant"})}},[n,o,r]),s.jsx("div",{className:"content-panel",children:s.jsx("div",{className:"content-scroll",children:n||o&&o.length>0||r?s.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[r&&s.jsxs("div",{className:"running-indicator",children:[s.jsx("div",{className:"spinner"}),s.jsx("span",{children:"程式執行中..."})]}),n&&s.jsx("pre",{className:"output-text",children:n}),o&&o.length>0&&s.jsx("div",{className:"output-images",children:o.map((c,f)=>s.jsx("div",{className:"output-image",children:s.jsx("img",{src:c,alt:`Plot ${f+1}`})},f))})]}):u?s.jsx("div",{className:"markdown-body",dangerouslySetInnerHTML:{__html:u}}):s.jsxs("div",{className:"welcome-screen",children:[s.jsx("h2",{children:"👈 請從上方選擇章節開始學習"}),s.jsx("p",{children:"選擇章節後，可以查看內容並執行程式碼"})]})})})});function _e({pyodide:a}){return null}let I=null;async function ve(a){if(I)return a&&a(100,"Ready"),I;const e=(t,n)=>{a&&a(t,n)};try{e(0,"Initialize Pyodide (v0.26.4)...");let t=null,n=3;for(;n>0;)try{t=await window.loadPyodide({indexURL:"https://cdn.jsdelivr.net/pyodide/v0.26.4/full/"});break}catch(r){if(console.warn(`Failed to load Pyodide (attempts left: ${n-1}):`,r),n--,n===0)throw r;await new Promise(o=>setTimeout(o,1e3))}return e(20,"Loading core packages (numpy, pandas, matplotlib, scipy)..."),await Promise.all([t.loadPackage("micropip"),t.loadPackage("numpy"),t.loadPackage("pandas"),t.loadPackage("matplotlib"),t.loadPackage("scipy")]),e(70,"Initializing core environment..."),await t.loadPackage("micropip"),e(75,"Configuring environment..."),await t.runPythonAsync(`
import warnings
...
print("✅ Python input() function hooked to window.prompt")
        `),I=t,e(100,"Ready!"),t}catch(t){throw console.error("Failed to load Pyodide:",t),t}}async function be(a,e,t=3e4){let n;const r=new Promise((o,m)=>{n=setTimeout(()=>{m(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([a.runPythonAsync(e),r])}finally{clearTimeout(n)}}async function we(a){if(a)try{await a.runPythonAsync(`
import gc
import matplotlib.pyplot as plt
plt.close('all')
gc.collect()
        `)}catch{}}async function xe(a){try{const e=await a.runPythonAsync(`
import matplotlib.pyplot as plt
len(plt.get_fignums())
...
if plt.style.available and 'default' in plt.style.available:
    ...
    `),console.log(`✓ Matplotlib 初始化完成 (Backend: ${t})`)}catch(t){console.error("✗ Matplotlib 初始化失敗:",t)}}async function Pe(a){try{await a.runPythonAsync(`
import matplotlib.pyplot as plt
if len(plt.get_fignums()) > 0:
    plt.show()
    `)}catch(e){console.error("Failed to show plots:",e)}}function U(a){const e=a.message||String(a),t=[{pattern:/NameError: name '(.+)' is not defined/,format:n=>`❌ 變數錯誤：'${n[1]}' 未定義
...
• 逐行執行程式碼找出問題
• 使用 print() 輸出變數值
• 簡化程式碼，逐步測試`}class ke{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),n=this.metrics[e].start,r=t-n;return this.metrics[e].end=t,this.metrics[e].duration=r,this.log(e,r),r}log(e,t){const n=t<100?"⚡":t<1e3?"⏱️":"🐌",r=t<100?"color: green":t<1e3?"color: orange":"color: red";console.log(`%c${n} ${e}: ${t.toFixed(2)}ms`,r),t>1e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,n)=>t+n,0),average:e.reduce((t,n)=>t+n,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.log(`總計測量: ${e.count} 次`),console.log(`總時間: ${e.total.toFixed(2)}ms`),console.log(`平均時間: ${e.average.toFixed(2)}ms`),console.log(`最快: ${e.min.toFixed(2)}ms`),console.log(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,n])=>{n.duration!==null&&console.log(`${t}: ${n.duration.toFixed(2)}ms`)}),console.groupEnd()}}const N=new ke;N.setEnabled(!1);function Se(){if("PerformanceObserver"in window){new PerformanceObserver(r=>{const o=r.getEntries(),m=o[o.length-1];console.log("🎨 LCP:",m.renderTime||m.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(r=>{r.getEntries().forEach(m=>{console.log("⚡ FID:",m.processingStart-m.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(r=>{r.getEntries().forEach(m=>{m.hadRecentInput||(t+=m.value)}),console.log("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const Le=d.lazy(()=>ie(()=>import("./CodePreviewPanel-Y1A0b_QJ.js"),__vite__mapDeps([0,1,2,3,4]))),Z={pandas:"pandas",matplotlib:"matplotlib",scipy:"scipy",statsmodels:"statsmodels",sympy:"sympy",autograd:"autograd",lxml:"lxml",openpyxl:"openpyxl",requests:"requests",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",mpl_toolkits:"matplotlib",pylab:"matplotlib"},J={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"};function Ee(){const[a,e]=d.useState(null),[t,n]=d.useState(!0),[r,o]=d.useState(0),[m,u]=d.useState("初始化中..."),[c,f]=d.useState([]),[P,g]=d.useState(!0),[w,$]=d.useState(null),[C,x]=d.useState(null),[j,_]=d.useState(""),[A,E]=d.useState([]),[D,F]=d.useState(!1),[B,X]=d.useState(!1),[k,ee]=d.useState(()=>{const l=localStorage.getItem("theme");return l==="dark"||!l&&window.matchMedia("(prefers-color-scheme: dark)").matches}),[T,te]=d.useState(500),[Q]=d.useState(new Set),[O,W]=d.useState(null);d.useEffect(()=>{g(!0);const l=`/pwa_FRM_Book1_python/data/chapters.json?t=${Date.now()}`;fetch(l).then(i=>i.json()).then(i=>{i&&i.length>0&&f(i),g(!1)}).catch(i=>{console.error("Failed to load chapters:",i),g(!1)})},[]),d.useEffect(()=>{ve((i,h)=>{o(i),u(h)}).then(i=>{e(i),n(!1),N.end("pyodide-init")}),Se();const l=[];if("serviceWorker"in navigator){const i=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(b=>{b.forEach(v=>v.update())})},36e5),h=()=>{document.hidden||console.log("New Service Worker activated.")};navigator.serviceWorker.addEventListener("controllerchange",h),l.push(()=>{clearInterval(i),navigator.serviceWorker.removeEventListener("controllerchange",h)})}if("storage"in navigator&&"estimate"in navigator.storage){const i=async()=>{try{const b=await navigator.storage.estimate();if(b.usage&&b.quota){const v=b.usage/b.quota*100;console.log(`Storage usage: ${v.toFixed(2)}%`),v>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}}catch(b){console.warn("Failed to check storage quota:",b)}};i();const h=setInterval(i,300*1e3);l.push(()=>clearInterval(h))}return()=>{l.forEach(i=>i())}},[]),d.useEffect(()=>{localStorage.setItem("theme",k?"dark":"light"),document.documentElement.setAttribute("data-theme",k?"dark":"light")},[k]);const z=async(l,i=!1)=>{var G;if(!a)return;const h=l.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!h)return;const b=["sys","os","io","time","base64","json","datetime","math","re","warnings","builtins","types"],v=["numpy","pandas","matplotlib","scipy","micropip","js","builtins","QuantLib"],S=[...new Set(h.map(y=>{const p=y.trim().split(/\s+/);return p[0]==="from",p[1].split(".")[0]}))].filter(y=>!b.includes(y)&&!v.includes(y)).filter(y=>!Q.has(y));if(S.length===0)return;const q=[],H=new URL("/pwa_FRM_Book1_python/",window.location.origin).href;if(S.forEach(y=>{const p=Z[y];p?(q.push(p.endsWith(".whl")?H+p:p),(J[y]||[]).forEach(M=>{const R=J[M]||M;q.push(R.endsWith(".whl")?H+R:R)})):q.push(y)}),q.length>0)try{const y=[...new Set(q)];i||_(p=>p+`正在動態載入所需套件 [${S.join(", ")}]...
`),await a.loadPackage("micropip"),await a.runPythonAsync(`
import micropip
await micropip.install(${JSON.stringify(y)}, keep_going=True)
        `),S.includes("matplotlib")&&(await V(a),O||W("AGG")),S.forEach(p=>{Q.add(p);const L=Z[p];L&&!L.endsWith(".whl")&&Q.add(L)}),i||_(p=>p+`✅ 套件載入完成。
`)}catch(y){if(console.warn("Dependency loading failed:",y),!i){const p=y.message||String(y);if(p.includes("Can't find a pure Python 3 wheel")){const L=((G=p.match(/for: '([^']+)'/))==null?void 0:G[1])||"unknown";_(M=>M+`⚠️ 套件 "${L}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else _(L=>L+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},ae=async l=>{if(!(!a||D||!l)){N.start("run-code"),F(!0),_(`執行中...
`),E([]);try{await we(a);const i=l.includes("matplotlib.widgets")||l.includes("Slider")||l.includes("Button");X(i);const h=i?"module://matplotlib_pyodide.wasm_backend":"AGG";if(O!==h&&(await V(a,i),W(h)),await a.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),i){const v=document.getElementById("pyodide-plot-container");v&&(v.innerHTML="",window.document.pyodideMplTarget=v)}await z(l);try{await be(a,l)}catch(v){const S=await a.runPythonAsync("sys.stdout.getvalue()"),q=U(v);_((S?S+`
`:"")+q),F(!1),N.end("run-code");return}const b=await a.runPythonAsync("sys.stdout.getvalue()");if(_(b||"執行完成（無文字內容輸出 ）"),B)await Pe(a);else{const v=await xe(a);E(v)}}catch(i){const h=U(i);_(h),console.error(i)}finally{F(!1),N.end("run-code")}}},se=l=>{if($(l),x(null),_(""),E([]),l&&l.examples&&a){const i=l.examples.map(h=>h.code).join(`
`);z(i,!0)}},ne=l=>{x(l),_(""),E([])},re=l=>{x(l),_(""),E([])},oe=()=>{x(null),_(""),E([])};return t?s.jsx("div",{className:"loading-screen",children:s.jsxs("div",{className:"loading-content",children:[s.jsx("div",{className:"loading-spinner"}),s.jsx("h2",{children:"正在載入 Python 執行環境..."}),s.jsx("div",{className:"progress-container",children:s.jsx("div",{className:"progress-bar",style:{width:`${r}%`}})}),s.jsxs("p",{className:"loading-text",children:[m," (",r,"%)"]}),s.jsx("p",{className:"loading-hint",children:"首次載入需要下載約 10MB 的資源，請稍候"})]})}):s.jsxs("div",{className:`app ${k?"dark":""}`,children:[s.jsxs("div",{className:"main-content",children:[s.jsxs("div",{className:"top-bar",children:[s.jsxs("div",{className:"top-bar-left",children:[s.jsx(le,{size:20,className:"logo-icon"}),s.jsx("span",{className:"app-title",children:"FRM_Book1 (基礎篇)"})]}),s.jsx(ge,{chapters:c,currentChapter:w,onChapterSelect:se,currentScript:C,onScriptSelect:re,loading:P}),s.jsx("div",{className:"top-bar-right",children:s.jsx("button",{className:"theme-toggle",onClick:()=>ee(!k),title:k?"切換到亮色模式":"切換到暗色模式",children:k?s.jsx(de,{size:20}):s.jsx(ce,{size:20})})})]}),s.jsxs("div",{className:"panes-container",children:[s.jsx("div",{className:"content-pane",children:s.jsx(ye,{chapter:w,onCodeClick:ne,darkMode:k,output:j,isRunning:D,plotImages:A,onClearOutput:()=>{_(""),E([])}})}),C&&s.jsx("div",{className:"preview-pane",style:{width:`${T}px`},children:s.jsx(d.Suspense,{fallback:s.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:s.jsx(Le,{script:C,onClose:oe,onRun:ae,isRunning:D,output:j,images:A,isInteractive:B,darkMode:k,width:T,onResize:te})})})]})]}),s.jsx(_e,{pyodide:a})]})}me.createRoot(document.getElementById("root")).render(s.jsx(pe.StrictMode,{children:s.jsx(Ee,{})}));
